...
public class ActivitiStateHandlerRegistrationTest {
  ...
  public void shouldHaveDetailledStringRepresentation() throws Exception {
    ...
    assertEquals("org.cibseven.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistration@" + Integer.toHexString(registration.hashCode()) + "["
        + "processVariablesExpected={34=testValue}, "
        + "handlerMethod=public void org.cibseven.bpm.engine.spring.test.components.registry.ActivitiStateHandlerRegistrationTest.shouldHaveDetailledStringRepresentation() throws java.lang.Exception, "
        + "handler=org.cibseven.bpm.engine.spring.test.components.registry.ActivitiStateHandlerRegistrationTest$1@" + Integer.toHexString(handler.hashCode()) + ", "
        + "stateName=running, "
        + "beanName=testBean, "
