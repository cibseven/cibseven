 ...
 * @author Pablo Ganga
 */
@ContextConfiguration("classpath:org/cibseven/bpm/engine/spring/test/components/SpringjobExecutorTest-context.xml")
public class SpringJobExecutorTest extends SpringProcessEngineTestCase {

  @Deployment(resources={"org/cibseven/bpm/engine/spring/test/components/SpringTimersProcess.bpmn20.xml",
          "org/cibseven/bpm/engine/spring/test/components/SpringJobExecutorRollBack.bpmn20.xml"})
