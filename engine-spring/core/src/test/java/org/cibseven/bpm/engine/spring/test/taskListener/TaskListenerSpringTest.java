 ...
 */
package org.cibseven.bpm.engine.spring.test.taskListener;
 ...
 * @author Joram Barrez
 */
@ContextConfiguration("classpath:org/cibseven/bpm/engine/spring/test/taskListener/TaskListenerDelegateExpressionTest-context.xml")
