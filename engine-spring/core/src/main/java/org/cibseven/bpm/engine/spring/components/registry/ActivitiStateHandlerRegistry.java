...
/**
 * this class records and manages all known {@link org.cibseven.bpm.engine.annotations.State} - responding
...
public class ActivitiStateHandlerRegistry extends ReceiveTaskActivityBehavior implements BeanFactoryAware, BeanNameAware, ActivityBehavior, InitializingBean {
	...
	protected String registrationKey(String stateName, String processName) {
		return (org.cibseven.commons.utils.StringUtil.defaultString(processName) +
				":" + org.cibseven.commons.utils.StringUtil.defaultString(stateName)).toLowerCase();
	}

	/**
	 * used at runtime to register state handlers as they are registered with the spring context
	 *
	 * @param registration the {@link org.cibseven.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistration}
	 */
	 ...
	 * on specificity of the {@link org.cibseven.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistration}
	 *
	 ...
	 * @return an unambiguous {@link org.cibseven.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistry} or null
	 */
