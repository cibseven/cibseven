 ...
 */
package org.cibseven.bpm.engine.spring.annotations;
...
public @interface StartProcess {
	...
	/**
	 * returns the ID of the {@link org.cibseven.bpm.engine.runtime.ProcessInstance}. If specified, it'll only work if
	 * the return type of the invocation is compatabile with a {@link org.cibseven.bpm.engine.runtime.ProcessInstance}'s ID
