 ...
 */
package org.cibseven.bpm.engine.spring.components.config.xml;


import org.cibseven.bpm.engine.spring.components.ActivitiContextUtils;
import org.cibseven.bpm.engine.spring.components.aop.ProcessStartAnnotationBeanPostProcessor;
...
/**
 * registers support for handling the annotations in the org.cibseven.bpm.engine.annotations package.
 * <p/>
 ...
 * {@link org.cibseven.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistry} if none exists.
 *
 * @author Josh Long
 * @since 5.3
 */
