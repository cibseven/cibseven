...
public class ResolveBeanFromDmnTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/functional/el/BusinessRuleProcess.bpmn20.xml")
      .addAsResource("org/cibseven/bpm/integrationtest/functional/el/BeanResolvingDecision.dmn11.xml");
  }
