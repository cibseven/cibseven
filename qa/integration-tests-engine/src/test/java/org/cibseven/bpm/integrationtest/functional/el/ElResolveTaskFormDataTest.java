...
public class ElResolveTaskFormDataTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/functional/el/elTaskFormProcessWithFormData.bpmn20.xml");
  }

  @Test
  void taskFormDataWithDefaultValueExpression() {
  ...
  @Test
  void taskFormDataWithLabelExpression() {
    ProcessInstance instance = runtimeService.startProcessInstanceByKey("elTaskFormProcess");
    Task task = taskService.createTaskQuery().processInstanceId(instance.getId()).singleResult();
