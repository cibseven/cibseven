...
import org.cibseven.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBean;
import org.cibseven.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBeanLocal;
import org.cibseven.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterService;
import org.cibseven.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterServiceBean;
import org.cibseven.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterServiceLocal;
import org.cibseven.bpm.integrationtest.functional.ejb.request.beans.RequestScopedSFSBDelegate;
...
public class JobExecutorRequestContextLocalInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/request/JobExecutorRequestContextLocalInvocationTest.testContextPropagationEjbLocal.bpmn20.xml")
      .addAsWebInfResource("org/cibseven/bpm/integrationtest/functional/ejb/request/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
...
//    "global/" +
//    "service/" +
//    "InvocationCounterServiceBean!org.cibseven.bpm.integrationtest.functional.cdi.beans.InvocationCounterServiceLocal");
//
