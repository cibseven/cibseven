...
import org.cibseven.bpm.integrationtest.functional.ejb.local.bean.BusinessInterface;
import org.cibseven.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBean;
import org.cibseven.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBeanClientDelegateBean;
...
public class LocalSingletonBeanInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/local/LocalSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml")
  ...
  public void testInvokeBean() throws Exception{
    ...
    assertThat(true).isEqualTo(runtimeService.getVariable(pi.getId(), "result"));
  ...
  public void testMultipleInvocations() {
    ...
    for(int i=0; i<instances; i++) {
      ...
      assertThat(true).isEqualTo(runtimeService.getVariable(ids[i], "result"));
