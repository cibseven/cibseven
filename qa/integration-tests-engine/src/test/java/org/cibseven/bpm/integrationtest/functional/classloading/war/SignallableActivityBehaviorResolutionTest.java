...
import org.cibseven.bpm.integrationtest.functional.classloading.beans.ExampleSignallableActivityBehavior;
...
public class SignallableActivityBehaviorResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("org/cibseven/bpm/integrationtest/functional/classloading/SignallableActivityBehaviorResolutionTest.testResolveClass.bpmn20.xml")
            .addAsResource("org/cibseven/bpm/integrationtest/functional/classloading/SignallableActivityBehaviorResolutionTest.testResolveClassFromJobExecutor.bpmn20.xml");
  }
  ...
  void resolveClass() {
    ...
    try {
      Class.forName("org.cibseven.bpm.integrationtest.functional.classloading.beans.ExampleSignallableActivityBehavior");
      fail("CNFE expected");
  ...
  @Test
  @OperateOnDeployment("clientDeployment")
  void resolveClassFromJobExecutor() throws InterruptedException {
