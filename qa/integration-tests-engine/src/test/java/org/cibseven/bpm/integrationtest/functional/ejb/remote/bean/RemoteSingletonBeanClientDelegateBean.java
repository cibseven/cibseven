 ...
 */
package org.cibseven.bpm.integrationtest.functional.ejb.remote.bean;
...
public class RemoteSingletonBeanClientDelegateBean implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) throws Exception {
    BusinessInterface businessInterface = (BusinessInterface) new InitialContext().lookup("java:global/" +
        ...
        "service/" +
        "RemoteSingletonBean!org.cibseven.bpm.integrationtest.functional.ejb.remote.bean.BusinessInterface");
