...
import org.cibseven.bpm.integrationtest.functional.ejb.beans.SingletonBeanClientDelegate;
import org.cibseven.bpm.integrationtest.functional.ejb.beans.SingletonBeanDelegate;
...
public class SingletonBeanDelegateTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/SingletonBeanDelegateTest.testBeanResolution.bpmn20.xml")
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/SingletonBeanDelegateTest.testBeanResolutionFromClient.bpmn20.xml");
  }
  ...
  void beanResolution() {
    ...
    assertThat(runtimeService.getVariable(pi.getId(), SingletonBeanDelegate.class.getName())).isEqualTo(true);
  ...
  void multipleInvocations() {
    ...
    for(int i=0; i<instances; i++) {
      ...
      assertThat(runtimeService.getVariable(ids[i], SingletonBeanDelegate.class.getName())).as("Incovation=" + i).isEqualTo(true);
