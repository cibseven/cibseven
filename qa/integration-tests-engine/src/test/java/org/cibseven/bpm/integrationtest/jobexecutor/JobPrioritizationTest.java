...
public class JobPrioritizationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/jobexecutor/JobPrioritizationTest.priorityProcess.bpmn20.xml")
      .addAsResource("org/cibseven/bpm/integrationtest/jobexecutor/JobPrioritizationTest.serviceTask.bpmn20.xml")
      .addAsResource("org/cibseven/bpm/integrationtest/jobexecutor/JobPrioritizationTest.userTask.bpmn20.xml")
      .addAsResource("org/cibseven/bpm/integrationtest/jobexecutor/JobPrioritizationTest.intermediateMessage.bpmn20.xml");
  }
  ...
  @Test
  void priorityOnInstantiationAtActivity() {
  ...
  @Test
  void priorityOnAsyncAfterUserTask() {
    // given
    ...
    assertThat(asyncAfterJob.getPriority()).isEqualTo(PriorityBean.PRIORITY);
  }

  @Test
  void priorityOnAsyncAfterIntermediateCatchEvent() {
    // given
