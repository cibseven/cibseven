...
import org.cibseven.bpm.integrationtest.functional.ejb.local.bean.StartProcessInterface;
import org.cibseven.bpm.integrationtest.functional.ejb.local.bean.StartProcessSLSB;
...
public class LocalSLSBInvocationWithCallbackTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/local/LocalSLSBInvocationTest.testStartProcess.bpmn20.xml")
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/local/LocalSLSBInvocationTest.callbackProcess.bpmn20.xml")
      .addAsWebInfResource("org/cibseven/bpm/integrationtest/functional/ejb/local/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
  ...
  public static WebArchive delegateDeployment() {
    WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "service.war")
      ...
      .addAsManifestResource(new StringAsset("Dependencies: org.cibseven.bpm.cibseven-engine"), "MANIFEST.MF"); // get access to engine classes
