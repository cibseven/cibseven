...
import org.cibseven.bpm.integrationtest.functional.ejb.beans.SFSBClientDelegate;
import org.cibseven.bpm.integrationtest.functional.ejb.beans.SFSBDelegate;
...
public class SFSBDelegateTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/SFSBDelegateTest.testBeanResolution.bpmn20.xml")
      .addAsResource("org/cibseven/bpm/integrationtest/functional/ejb/SFSBDelegateTest.testBeanResolutionFromClient.bpmn20.xml");
  }
  ...
  void multipleInvocations() {
    ...
    for(int i=0; i<instances; i++) {
      ...
      assertThat(runtimeService.getVariable(ids[i], SFSBDelegate.class.getName())).as("Incovation=" + i).isEqualTo(true);
