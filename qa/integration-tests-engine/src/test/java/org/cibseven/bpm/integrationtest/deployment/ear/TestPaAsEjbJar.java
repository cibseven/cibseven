...
import org.cibseven.bpm.integrationtest.deployment.ear.beans.NamedCdiBean;
...
public class TestPaAsEjbJar extends AbstractFoxPlatformIntegrationTest {
   ...
   *        |-- org/cibseven/bpm/integrationtest/deployment/ear/paAsEjbJar-process.bpmn20.xml
  ...
  public static EnterpriseArchive paAsEjbModule() throws Exception {
    ...
    JavaArchive processArchive1Jar = ShrinkWrap.create(JavaArchive.class, "pa.jar")
      ...
      .addAsResource("org/cibseven/bpm/integrationtest/deployment/ear/paAsEjbJar-process.bpmn20.xml")
      .addAsResource("META-INF/processes.xml", "META-INF/processes.xml")
      .addAsManifestResource("org/cibseven/bpm/integrationtest/beans.xml", "beans.xml");
