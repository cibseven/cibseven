 ...
 */
package org.cibseven.bpm.qa.performance.engine.bpmn;

import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE1;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE10;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE2;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE3;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE4;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE5;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE6;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE7;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE8;
import static org.cibseven.bpm.qa.performance.engine.steps.PerfTestConstants.VARIABLE9;
 ...
 *
 */
class VariablesPerformanceTest extends ProcessEnginePerformanceTestCase {


  @Test
  @Deployment(resources =
    {"org/cibseven/bpm/qa/performance/engine/bpmn/StartEventPerformanceTest.noneStartEvent.bpmn"})
  void noneStartEventStringVar() {
  ...
  @Deployment(resources =
    {"org/cibseven/bpm/qa/performance/engine/bpmn/StartEventPerformanceTest.noneStartEvent.bpmn"})
  void noneStartEvent10StringVars() {
    HashMap<String, Object> variables = new HashMap<String, Object>();
    variables.put(VARIABLE1, "someValue");
  ...
  @Deployment(resources =
    {"org/cibseven/bpm/qa/performance/engine/bpmn/StartEventPerformanceTest.noneStartEvent.bpmn"})
  void noneStartEventLargeByteVar() {
    HashMap<String, Object> variables = new HashMap<String, Object>();
