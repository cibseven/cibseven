 ...
 */
package org.cibseven.bpm.qa.upgrade.scenarios.job;
...
public class AsyncSequentialMultiInstanceScenario {
  ...
  public static String deployAsyncBeforeProcess() {
    return "org/cibseven/bpm/qa/upgrade/job/asyncBeforeSequentialMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployAsyncBeforeTask() {
    return "org/cibseven/bpm/qa/upgrade/job/asyncBeforeSequentialMultiInstanceTask.bpmn20.xml";
  }
