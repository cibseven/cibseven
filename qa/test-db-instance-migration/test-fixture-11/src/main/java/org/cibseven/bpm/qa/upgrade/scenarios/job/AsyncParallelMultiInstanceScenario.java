...
public class AsyncParallelMultiInstanceScenario {
  ...
  public static String deployAsyncBeforeSubprocessProcess() {
    return "org/cibseven/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployAsyncBeforeTaskProcess() {
    return "org/cibseven/bpm/qa/upgrade/job/asyncBeforeParallelMultiInstanceTask.bpmn20.xml";
  }
