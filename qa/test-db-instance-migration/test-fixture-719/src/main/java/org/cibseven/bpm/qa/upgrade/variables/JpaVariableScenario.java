 ...
 */
package org.cibseven.bpm.qa.upgrade.variables;
...
import org.cibseven.bpm.engine.impl.variable.serializer.jpa.EntityManagerSession;
import org.cibseven.bpm.engine.impl.variable.serializer.jpa.EntityManagerSessionFactory;
...
public class JpaVariableScenario {
  ...
  public static String deployOneTask() {
    return "org/cibseven/bpm/qa/upgrade/variables/JpaEntitiesScenario.oneTaskProcess.bpmn20.xml";
  }
