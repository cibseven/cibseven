 ...
 */
package org.cibseven.bpm.qa.upgrade.scenarios.boundary;
...
public class NestedNonInterruptingBoundaryEventOnOuterSubprocessScenario {
  ...
  public static String deployTimerBoundary() {
    return "org/cibseven/bpm/qa/upgrade/boundary/nestedNonInterruptingTimerBoundaryEventOnOuterSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "org/cibseven/bpm/qa/upgrade/boundary/nestedNonInterruptingMessageBoundaryEventOnOuterSubprocess.bpmn20.xml";
  }
