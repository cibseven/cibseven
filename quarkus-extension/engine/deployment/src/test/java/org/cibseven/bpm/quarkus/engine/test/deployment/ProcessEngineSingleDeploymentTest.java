 ...
 */
package org.cibseven.bpm.quarkus.engine.test.deployment;
...
import org.cibseven.bpm.quarkus.engine.extension.event.CamundaEngineStartupEvent;
...
public class ProcessEngineSingleDeploymentTest {
  ...
  protected static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
          .addAsResource("org/cibseven/bpm/quarkus/engine/test/deployment/simpleServiceTaskProcess.bpmn"));
  ...
  static class MyConfig {
    ...
    public void createDeployment(@Observes CamundaEngineStartupEvent event) {
      repositoryService.createDeployment()
          .addClasspathResource("org/cibseven/bpm/quarkus/engine/test/deployment/simpleServiceTaskProcess.bpmn")
          .deploy();
    }
