...
import static org.cibseven.bpm.engine.rest.util.EngineUtil.getProcessEngineProvider;
...
import org.cibseven.bpm.engine.rest.CaseDefinitionRestService;
import org.cibseven.bpm.engine.rest.CaseExecutionRestService;
import org.cibseven.bpm.engine.rest.CaseInstanceRestService;
import org.cibseven.bpm.engine.rest.ConditionRestService;
import org.cibseven.bpm.engine.rest.DecisionDefinitionRestService;
import org.cibseven.bpm.engine.rest.DecisionRequirementsDefinitionRestService;
import org.cibseven.bpm.engine.rest.DeploymentRestService;
import org.cibseven.bpm.engine.rest.EventSubscriptionRestService;
...
import org.cibseven.bpm.engine.rest.GroupRestService;
import org.cibseven.bpm.engine.rest.IdentityRestService;
...
import org.cibseven.bpm.engine.rest.VariableInstanceRestService;
import org.cibseven.bpm.engine.rest.dto.ProcessEngineDto;
import org.cibseven.bpm.engine.rest.history.HistoryRestService;
import org.cibseven.bpm.engine.rest.impl.optimize.OptimizeRestService;
