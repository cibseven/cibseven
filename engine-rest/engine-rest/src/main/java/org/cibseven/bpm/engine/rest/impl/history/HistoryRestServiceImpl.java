...
import org.cibseven.bpm.engine.rest.history.HistoricActivityInstanceRestService;
import org.cibseven.bpm.engine.rest.history.HistoricProcessDefinitionRestService;
import org.cibseven.bpm.engine.rest.history.HistoricBatchRestService;
import org.cibseven.bpm.engine.rest.history.HistoricCaseActivityInstanceRestService;
import org.cibseven.bpm.engine.rest.history.HistoricCaseDefinitionRestService;
import org.cibseven.bpm.engine.rest.history.HistoricCaseInstanceRestService;
import org.cibseven.bpm.engine.rest.history.HistoricDecisionDefinitionRestService;
import org.cibseven.bpm.engine.rest.history.HistoricDecisionInstanceRestService;
import org.cibseven.bpm.engine.rest.history.HistoricDecisionStatisticsRestService;
import org.cibseven.bpm.engine.rest.history.HistoricDetailRestService;
import org.cibseven.bpm.engine.rest.history.HistoricExternalTaskLogRestService;
import org.cibseven.bpm.engine.rest.history.HistoricIdentityLinkLogRestService;
import org.cibseven.bpm.engine.rest.history.HistoricIncidentRestService;
import org.cibseven.bpm.engine.rest.history.HistoricJobLogRestService;
import org.cibseven.bpm.engine.rest.history.HistoricProcessInstanceRestService;
import org.cibseven.bpm.engine.rest.history.HistoricTaskInstanceRestService;
import org.cibseven.bpm.engine.rest.history.HistoricVariableInstanceRestService;
import org.cibseven.bpm.engine.rest.history.HistoryCleanupRestService;
import org.cibseven.bpm.engine.rest.history.HistoryRestService;
import org.cibseven.bpm.engine.rest.history.UserOperationLogRestService;
