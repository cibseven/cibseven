...
import org.cibseven.bpm.engine.history.HistoricCaseActivityStatistics;
...
import org.cibseven.bpm.engine.impl.telemetry.dto.CommandImpl;
...
import org.cibseven.bpm.engine.impl.telemetry.dto.MetricImpl;
...
public abstract class MockProvider {
  ...
  public static final boolean EXAMPLE_HISTORIC_EXTERNAL_TASK_LOG_IS_FETCHED_LOG = true;
  ...
  public static HistoricExternalTaskLog createMockHistoricExternalTaskLog(String tenantId) {
    ...
    when(mock.isFetchedLog()).thenReturn(EXAMPLE_HISTORIC_EXTERNAL_TASK_LOG_IS_FETCHED_LOG);
