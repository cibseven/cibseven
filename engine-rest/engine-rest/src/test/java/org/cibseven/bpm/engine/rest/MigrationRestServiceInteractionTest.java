...
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOBS_PER_SEED;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOB_DEFINITION_ID;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TOTAL_JOBS;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TYPE;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_INVOCATIONS_PER_BATCH_JOB;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_MONITOR_JOB_DEFINITION_ID;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_SEED_JOB_DEFINITION_ID;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.NON_EXISTING_ACTIVITY_ID;
...
import org.cibseven.bpm.engine.rest.dto.migration.MigrationInstructionDto;
import org.cibseven.bpm.engine.rest.dto.runtime.ProcessInstanceQueryDto;
import org.cibseven.bpm.engine.rest.helper.FluentAnswer;
import org.cibseven.bpm.engine.rest.helper.MockMigrationPlanBuilder;
