...
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_JOB_DEFINITION_ID;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID_LIST;
import static org.cibseven.bpm.engine.rest.helper.MockProvider.NON_EXISTING_JOB_DEFINITION_ID;
...
public class IncidentRestServiceQueryTest extends AbstractRestServiceTest {
  ...
  public void testSimpleIncidentQuery() {
    ...
    Assertions.assertNotNull(incidents.get(0), "The returned incident should not be null.");
