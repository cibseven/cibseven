...
import org.cibseven.bpm.engine.rest.helper.MockHistoricVariableUpdateBuilder;
...
public class HistoricDetailRestServiceQueryTest extends AbstractRestServiceTest {
  ...
  private void verifySimpleHistoricActivityQueryResponse(Response response) {
    ...
    Assertions.assertNotNull(details.get(0), "The returned details should not be null.");
    Assertions.assertNotNull(details.get(1), "The returned details should not be null.");
