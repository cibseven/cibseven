<#macro endpoint_macro docsUrl="">
{
  ...
  <@lib.endpointInfo
      id = "getStartFormVariables"
      tag = "Process Definition"
      summary = "Get Process Definition Start Form Variables"
      desc = "Retrieves the start form variables for a process definition
  ...
  "parameters" : [
    ...
    <@lib.parameter
        ...
        type = "string"
        required = true
        desc = "The id of the process definition to retrieve the variables for." />
  ...
  "responses" : {
    ...
    <@lib.response
        ...
        dto = "ExceptionDto"
        last = true
        desc = "The id is null or does not exist. See the
