...
```
 ...
 | | +--sort-props.ftl
 +--models
 | +--org/cibseven/bpm/engine/rest/dto
 | | +--ExceptionDto.ftl
 | | +--history
...
([org.cibseven.bpm.engine.rest.dto.ExceptionDto.java](https://github.com/cibseven/cibseven/blob/master/engine-rest/engine-rest/src/main/java/org/cibseven/bpm/engine/rest/dto/ExceptionDto.java) --> 
[org/cibseven/bpm/engine/rest/dto/ExceptionDto.ftl](https://github.com/cibseven/cibseven/blob/master/engine-rest/engine-rest-openapi/src/main/templates/models/org/cibseven/bpm/engine/rest/dto/ExceptionDto.ftl))
...
* endpoints that are almost similar but have a different paths (e.g. [Get Activity Instance Statistics](https://docs.cibseven.org/rest/cibseven/1.1/#tag/Process-Definition/operation/getActivityStatistics)) needs to be separated in different files. A unique `operationId` should be assigned to each of them. You can consider adding the common parts of the endpoints in [lib/commons](#commons).
...
`docsUrl="https://docs.cibseven.org/manual/${docsVersion}"
...
```
    <@lib.property
        ...
        description = "Restrict to instances that were started before the given date.
                       By default (https://docs.cibseven.org/manual/${docsVersion}/reference/rest/overview/date-format/),
                       the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., 2013-01-23T14:42:45.000+0200." />
```
That will improve the clients that are generated from the OpenAPI documentation. **Note:** When using a 'date-time' in a 'GET' request (as URL parameter), it is important to use proper URL encoding as described in the [Date Format Overview](https://docs.cibseven.org/manual/develop/reference/rest/overview/date-format/)
