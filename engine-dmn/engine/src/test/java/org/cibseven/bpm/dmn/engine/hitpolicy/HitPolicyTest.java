 ...
 */
package org.cibseven.bpm.dmn.engine.hitpolicy;

import org.cibseven.bpm.dmn.engine.DmnDecisionRuleResult;
import org.cibseven.bpm.dmn.engine.DmnDecisionTableResult;
import org.cibseven.bpm.dmn.engine.impl.hitpolicy.DmnHitPolicyException;
import org.cibseven.bpm.dmn.engine.impl.transform.DmnTransformException;
...
class HitPolicyTest extends DmnEngineTest {
  ...
  private static final String DEFAULT_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.default.single.dmn";
  private static final String DEFAULT_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.default.compound.dmn";
  private static final String UNIQUE_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.unique.single.dmn";
  private static final String UNIQUE_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.unique.compound.dmn";
  private static final String ANY_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.any.single.dmn";
  private static final String ANY_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.any.compound.dmn";
  private static final String PRIORITY_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.priority.single.dmn";
  private static final String FIRST_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.first.single.dmn";
  private static final String FIRST_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.first.compound.dmn";
  private static final String OUTPUT_ORDER_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.outputOrder.single.dmn";
  private static final String RULE_ORDER_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.ruleOrder.single.dmn";
  private static final String RULE_ORDER_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.ruleOrder.compound.dmn";
  private static final String COLLECT_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.single.dmn";
  private static final String COLLECT_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.compound.dmn";
  private static final String COLLECT_SUM_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.sum.single.dmn";
  private static final String COLLECT_SUM_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.sum.compound.dmn";
  private static final String COLLECT_MIN_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.min.single.dmn";
  private static final String COLLECT_MIN_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.min.compound.dmn";
  private static final String COLLECT_MAX_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.max.single.dmn";
  private static final String COLLECT_MAX_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.max.compound.dmn";
  private static final String COLLECT_COUNT_SINGLE = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.count.single.dmn";
  private static final String COLLECT_COUNT_COMPOUND = "org/cibseven/bpm/dmn/engine/hitpolicy/HitPolicyTest.collect.count.compound.dmn";
  ...
  @DecisionResource(resource = COLLECT_COUNT_SINGLE)
  public void collectCountHitPolicySingleOutputMultipleMatchingRules(boolean input1, boolean input2, boolean input3, int expectedCount) {
  ...
  @DecisionResource(resource = COLLECT_COUNT_COMPOUND)
  public void collectCountHitPolicyCompoundOutputSingleMatchingRule(boolean input1, boolean input2, boolean input3) {
    assertThatThrownBy(() -> evaluateDecisionTable(input1, input2, input3, 1, 2L, 3d))
      .isInstanceOf(DmnHitPolicyException.class)
      .hasMessageStartingWith("DMN-03003");
  }
  ...
  @DecisionResource(resource = COLLECT_COUNT_COMPOUND)
  public void collectCountHitPolicyCompoundOutputMultipleMatchingRules(boolean input1, boolean input2, boolean input3) {
    assertThatThrownBy(() -> evaluateDecisionTable(input1, input2, input3, 1, 2L, 3d))
      .isInstanceOf(DmnHitPolicyException.class)
      .hasMessageStartingWith("DMN-03003");
  }
