 ...
 */
package org.cibseven.bpm.container.impl.jboss.service;

import org.cibseven.bpm.container.impl.jboss.config.ManagedJtaProcessEngineConfiguration;
...
import org.cibseven.bpm.container.impl.jboss.util.Tccl;
import org.cibseven.bpm.container.impl.jboss.util.Tccl.Operation;
import org.cibseven.bpm.container.impl.jmx.services.JmxManagedProcessEngineController;
...
import org.cibseven.bpm.engine.impl.cfg.JtaProcessEngineConfiguration;
...
public class MscManagedProcessEngineController extends MscManagedProcessEngine {
  ...
  private Object createInstance(String configurationClassName) {
    try {
      ...
      throw new ProcessEngineException("Could not load '"+configurationClassName+"': the class must be visible from the cibseven-wildfly-subsystem module.", e);
    }
  }
