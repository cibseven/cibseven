...
import org.cibseven.bpm.container.impl.jboss.service.ProcessApplicationModuleService;
...
public class ModuleDependencyProcessor implements DeploymentUnitProcessor {
  ...
  public static ModuleIdentifier MODULE_IDENTIFYER_PROCESS_ENGINE = ModuleIdentifier.create("org.cibseven.bpm.cibseven-engine");
  public static ModuleIdentifier MODULE_IDENTIFYER_XML_MODEL = ModuleIdentifier.create("org.cibseven.bpm.model.cibseven-xml-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_BPMN_MODEL = ModuleIdentifier.create("org.cibseven.bpm.model.cibseven-bpmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_CMMN_MODEL = ModuleIdentifier.create("org.cibseven.bpm.model.cibseven-cmmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_DMN_MODEL = ModuleIdentifier.create("org.cibseven.bpm.model.cibseven-dmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_SPIN = ModuleIdentifier.create("org.cibseven.spin.cibseven-spin-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_CONNECT = ModuleIdentifier.create("org.cibseven.connect.cibseven-connect-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_ENGINE_DMN = ModuleIdentifier.create("org.cibseven.bpm.dmn.cibseven-engine-dmn");
  public static ModuleIdentifier MODULE_IDENTIFYER_GRAAL_JS = ModuleIdentifier.create("org.graalvm.js.js-scriptengine");
  public static ModuleIdentifier MODULE_IDENTIFYER_JUEL = ModuleIdentifier.create("org.cibseven.bpm.juel.cibseven-juel");
