 ...
 */
package org.cibseven.bpm.container.impl.jboss.test;

import static org.cibseven.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons.DEFAULT_CORE_THREADS;
import static org.cibseven.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons.DEFAULT_JOB_EXECUTOR_THREADPOOL_NAME;
import static org.cibseven.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons.DEFAULT_KEEPALIVE_TIME;
import static org.cibseven.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons.DEFAULT_MAX_THREADS;
...
import org.cibseven.bpm.container.impl.jboss.extension.Element;
import org.cibseven.bpm.container.impl.jboss.extension.ModelConstants;
import org.cibseven.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons;
import org.cibseven.bpm.container.impl.jboss.service.MscManagedProcessEngineController;
import org.cibseven.bpm.container.impl.jboss.service.ServiceNames;
...
import org.cibseven.bpm.container.impl.plugin.BpmPlatformPlugins;
...
public class JBossSubsystemXMLTest extends AbstractSubsystemTest {
  ...
  public static final ServiceName PROCESS_ENGINE_SERVICE_BINDING_SERVICE_NAME = ContextNames.GLOBAL_CONTEXT_SERVICE_NAME
    ...
    .append("ProcessEngineService!org.cibseven.bpm.ProcessEngineService");
  ...
  static {
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.isDefault", "true");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.datasource", "java:jboss/datasources/ExampleDS");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.history-level", "audit");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.configuration", "org.cibseven.bpm.container.impl.jboss.config.ManagedJtaProcessEngineConfiguration");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.property.job-acquisition-name", "default");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.plugin.ldap.class", "org.cibseven.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.plugin.ldap.property.test", "abc");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.plugin.ldap.property.number", "123");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.process-engine.test.plugin.ldap.property.bool", "true");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.job-executor.thread-pool-name", "job-executor-tp");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.job-executor.core-threads", "5");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.job-executor.max-threads", "15");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.job-executor.queue-length", "15");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.job-executor.keepalive-time", "10");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.job-executor.allow-core-timeout", "false");
    EXPRESSION_PROPERTIES.put("org.cibseven.bpm.jboss.job-executor.job-acquisition.default.acquisition-strategy", "SEQUENTIAL");
  ...
  public void testInstallSubsystemWithEnginesPropertiesPlugins() throws Exception {
    ...
    assertEquals("org.cibseven.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin", processEnginePluginXml.getPluginClass());
...
//    System.out.println(operations);
  ...
  public void testInstallSubsystemWithJobExecutorAndPropertiesXml() throws Exception {
    ...
    // ServiceName: 'org.cibseven.bpm.platform.job-executor.job-executor-tp'
