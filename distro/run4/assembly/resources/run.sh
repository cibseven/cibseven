...
Please stop it or remove the file $PID_PATH."
    ...
    "$JAVA" -Dloader.path="$classPath" -Dcamunda.deploymentDir="$DEPLOYMENT_DIR" $JAVA_OPTS -jar "$BASEDIR/cibseven-bpm-run4-core.jar" --spring.config.location=file:"$configuration" &
