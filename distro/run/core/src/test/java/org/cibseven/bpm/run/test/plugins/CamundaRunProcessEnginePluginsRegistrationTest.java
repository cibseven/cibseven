...
public class CamundaRunProcessEnginePluginsRegistrationTest {
  ...
  public void shouldPickUpAllPluginConfigurations() {
    ...
    String pluginOne = "org.cibseven.bpm.run.test.plugins.TestFirstPlugin";
    String pluginTwo = "org.cibseven.bpm.run.test.plugins.TestSecondPlugin";
    String pluginThree = "org.cibseven.bpm.run.test.plugins.TestDefaultValuesPlugin";
