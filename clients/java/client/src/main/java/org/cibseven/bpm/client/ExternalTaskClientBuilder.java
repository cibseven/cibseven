 ...
 */
package org.cibseven.bpm.client;
...
public interface ExternalTaskClientBuilder {
  ...
  /**
   * Adds a custom strategy to the client for defining the org.cibseven.bpm.client.backoff between two requests.
   * This information is optional. By default {@link ExponentialBackoffStrategy} is applied.
   *
   * @param backoffStrategy which realizes a custom org.cibseven.bpm.client.backoff strategy
   * @return the builder
   */
