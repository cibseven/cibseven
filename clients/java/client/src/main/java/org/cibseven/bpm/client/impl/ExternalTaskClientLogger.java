...
import org.cibseven.bpm.client.variable.impl.format.serializable.SerializableLogger;
import org.cibseven.bpm.client.variable.impl.format.xml.DomXmlLogger;
...
public class ExternalTaskClientLogger extends BaseLogger {
  ...
  protected static final String PROJECT_LOGGER = "org.cibseven.bpm.client";
