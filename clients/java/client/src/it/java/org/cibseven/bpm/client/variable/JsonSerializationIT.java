...
import static org.cibseven.bpm.engine.variable.Variables.SerializationDataFormats.JSON;
...
import org.cibseven.bpm.client.exception.ValueMapperException;
...
public class JsonSerializationIT {
  ...
  public void shoudSetJsonListVariable() throws JSONException {
    ...
    assertThat(serializedValue.getType()).isEqualTo(OBJECT);
    assertThat(serializedValue.getObjectTypeName()).isEqualTo("java.util.ArrayList<org.cibseven.bpm.client.variable.JsonSerializable>");

    ObjectValue deserializedValue = task.getVariableTyped(VARIABLE_NAME_JSON);
    assertThat(deserializedValue.isDeserialized()).isTrue();
    assertThat(deserializedValue.getValue()).isEqualTo(variable);
    assertThat(deserializedValue.getType()).isEqualTo(OBJECT);
    assertThat(deserializedValue.getObjectTypeName()).isEqualTo("java.util.ArrayList<org.cibseven.bpm.client.variable.JsonSerializable>");
