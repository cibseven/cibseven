 ...
 */
package org.cibseven.spin.json.tree.type;
...
import org.cibseven.spin.impl.json.jackson.format.MapJacksonJsonTypeDetector;
import org.cibseven.spin.impl.json.jackson.format.SetJacksonJsonTypeDetector;
import org.cibseven.spin.json.mapping.Customer;
...
public class JsonJacksonTreeTypeDetectionTest {
  ...
  public void shouldDetectTypeFromObject() {
    ...
    assertThat(canonicalTypeString).isEqualTo("org.cibseven.spin.json.mapping.RegularCustomer");
  }
  ...
  public void shouldDetectListType() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.ArrayList<org.cibseven.spin.json.mapping.RegularCustomer>");
  }
  ...
  public void shouldDetectSetType() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.HashSet<org.cibseven.spin.json.mapping.RegularCustomer>");
  }
  ...
  public void shouldDetectMapType() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.Map<java.lang.String,org.cibseven.spin.json.mapping.RegularCustomer>");
  }
  ...
  public void shouldHandleListOfLists() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.ArrayList<java.util.ArrayList<org.cibseven.spin.json.mapping.RegularCustomer>>");
  }
  ...
  public void shouldHandleSetOfSets() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.HashSet<java.util.HashSet<org.cibseven.spin.json.mapping.RegularCustomer>>");
  }
  ...
  public void shouldHandleSetOfLists() {
    ...
    String canonicalTypeString =
        dataFormatWithSetTypeDetector.getCanonicalTypeName(nestedCustomers);
    assertThat(canonicalTypeString).isEqualTo("java.util.HashSet<java.util.ArrayList<org.cibseven.spin.json.mapping.RegularCustomer>>");
  }
  ...
  public void shouldHandleMapOfMaps() {
    ...
    assertThat(canonicalTypeString).isEqualTo("java.util.Map<java.lang.String,java.util.Map<java.lang.Integer,org.cibseven.spin.json.mapping.RegularCustomer>>");
  }
