...
public class ScriptEngineRule implements TestRule {
  ...
  /**
   * Create script engine from {@literal @}{@link org.cibseven.spin.impl.test.ScriptEngine} Annotation. The created
  ...
  /**
   * Get the script engine defined by the {@literal @}{@link org.cibseven.spin.impl.test.ScriptEngine} Annotation
   *
