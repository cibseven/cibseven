...
import org.cibseven.spin.SpinFactory;
...
public class DomXmlDataFormatWriterTest {
  ...
  // see https://github.com/camunda/camunda-bpm-platform/blob/master/engine-plugins/spin-plugin/src/main/java/org/cibseven/spin/plugin/impl/SpinValueSerializer.java
  ...
  public void testCustomStripSpaceXSL() throws Exception {
    ...
    try (final InputStream inputStream = DomXmlDataFormatWriterTest.class.getClassLoader()
        .getResourceAsStream("org/cibseven/spin/strip-space-preserve-space.xsl")) {
