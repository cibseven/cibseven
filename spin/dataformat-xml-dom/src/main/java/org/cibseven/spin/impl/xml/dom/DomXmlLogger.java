...
import org.cibseven.spin.xml.SpinXmlElementImplementationException;
...
public class DomXmlLogger extends SpinLogger {
  ...
  public static final DomXmlLogger XML_DOM_LOGGER = BaseLogger.createLogger(DomXmlLogger.class, PROJECT_CODE, "org.cibseven.spin.xml", "01");
