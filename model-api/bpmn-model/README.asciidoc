...
the tests in link:src/test/java/org/cibseven/bpm/model/bpmn/builder/ProcessBuilderTest.java[ProcessBuilderTest.java] or this
...
link:src/test/java/org/cibseven/bpm/model/bpmn/CreateModelTest.java[CreateModelTest.java].
...
link:src/main/java/org/cibseven/bpm/model/bpmn/instance[org.cibseven.bpm.model.bpmn.instance]
