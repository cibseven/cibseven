 ...
 */
package org.cibseven.spin.plugin.variable;

import org.cibseven.spin.json.SpinJsonNode;
import org.cibseven.spin.plugin.variable.value.builder.JsonValueBuilder;
import org.cibseven.spin.plugin.variable.value.builder.XmlValueBuilder;
import org.cibseven.spin.plugin.variable.value.impl.builder.JsonValueBuilderImpl;
import org.cibseven.spin.plugin.variable.value.impl.builder.XmlValueBuilderImpl;
