...
public class XmlSerializationTest extends PluggableProcessEngineTestCase {
  ...
  public void testOverloadedAppendMethod() {
    ...
    Reader xmlInput = SpinIoUtil.classpathResourceAsReader("org/cibseven/spin/plugin/XmlSerializationTest-input.xml");
    String expectedOutput = SpinIoUtil.fileAsString("org/cibseven/spin/plugin/XmlSerializationTest-output.xml");
