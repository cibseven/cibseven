 ...
 */
package org.cibseven.bpm.pa.demo;

import static org.cibseven.bpm.engine.authorization.Authorization.AUTH_TYPE_GRANT;
import static org.cibseven.bpm.engine.authorization.Permissions.ACCESS;
...
public class InvoiceDemoDataGenerator {
    ...
    public void createDemoData(ProcessEngine engine) {
      ...
      user.setEmail("demo@cibseven.org");
      ...
      user2.setEmail("john@cibseven.org");
      ...
      user3.setEmail("mary@cibseven.org");
      ...
      user4.setEmail("peter@cibseven.org");
