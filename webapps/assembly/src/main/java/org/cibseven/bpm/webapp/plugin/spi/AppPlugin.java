 ...
 */
package org.cibseven.bpm.webapp.plugin.spi;

import java.util.List;
import java.util.Set;

import org.cibseven.bpm.webapp.plugin.resource.PluginResourceOverride;
import org.cibseven.bpm.webapp.plugin.spi.impl.AbstractAppPlugin;
...
public interface AppPlugin {
   ...
   * <p>
   *
   * Typically, a plugin publishes its API via a subclass of {@link org.cibseven.bpm.cockpit.plugin.resource.AbstractPluginRootResource}.
   *
