 ...
 */
package org.cibseven.bpm.cockpit.plugin.spi;
 ...
 * {@link org.cibseven.bpm.cockpit.plugin.spi.impl.AbstractCockpitPlugin} as a base class.
 *
 * @author nico.rehwaldt
 *
 * @see org.cibseven.bpm.cockpit.plugin.spi.impl.AbstractCockpitPlugin
 */
public interface CockpitPlugin extends AppPlugin {
   ...
   * <p>
   *
   * Inside the plugin the queries may be executed via the {@link org.cibseven.bpm.cockpit.db.QueryService} that may be obtained through
   * {@link org.cibseven.bpm.cockpit.Cockpit#getQueryService(java.lang.String) }.
   *
