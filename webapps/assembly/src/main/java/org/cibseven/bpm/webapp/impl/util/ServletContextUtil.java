...
import org.cibseven.bpm.webapp.impl.security.auth.UserAuthenticationResource;
...
public class ServletContextUtil {
  ...
  protected static final String APP_PATH_ATTR_NAME =
    "org.cibseven.bpm.spring.boot.starter.webapp.applicationPath";

  protected static final String SUCCESSFUL_ET_ATTR_NAME =
    "org.cibseven.bpm.webapp.telemetry.data.stored";

  protected static final String AUTH_CACHE_TTL_ATTR_NAME =
    "org.cibseven.bpm.webapp.auth.cache.ttl";
