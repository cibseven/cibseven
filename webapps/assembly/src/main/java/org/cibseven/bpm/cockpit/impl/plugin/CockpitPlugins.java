 ...
 */
package org.cibseven.bpm.cockpit.impl.plugin;
...
import org.cibseven.bpm.cockpit.impl.plugin.resources.CockpitPluginsRootResource;
import org.cibseven.bpm.cockpit.impl.plugin.resources.BaseRootResource;
...
public class CockpitPlugins extends AbstractCockpitPlugin {
  ...
  private static final String[] MAPPING_FILES = {
    ...
    "org/cibseven/bpm/cockpit/plugin/base/queries/processInstance.xml",
    "org/cibseven/bpm/cockpit/plugin/base/queries/incident.xml"
  };
