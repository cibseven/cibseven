 ...
 */
package org.cibseven.bpm.webapp.impl.security;
...
public class SecurityActions {
  ...
  public static <T> T runWithoutAuthentication(SecurityAction<T> action, ProcessEngine processEngine) throws IOException, ServletException {
    ...
    org.cibseven.bpm.engine.impl.identity.Authentication currentAuth = identityService.getCurrentAuthentication();
