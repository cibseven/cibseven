 ...
 */
package org.cibseven.bpm.container.impl.threading.ra.inflow;
...
import org.cibseven.bpm.container.impl.threading.ra.JcaExecutorServiceConnector;
...
public class JcaInflowExecuteJobsRunnable extends ExecuteJobsRunnable {
   ...
   * @see org.cibseven.bpm.engine.impl.jobexecutor.ExecuteJobsRunnable#switchClassLoader()
   *
