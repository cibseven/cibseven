...
import org.cibseven.bpm.engine.query.NativeQuery;

/**
 * Allows querying of {@link org.cibseven.bpm.engine.history.HistoricVariableInstanceQuery}s via native (SQL) queries
 * @author Ramona Koch
 */
