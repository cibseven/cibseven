...
import org.cibseven.bpm.engine.history.CleanableHistoricCaseInstanceReport;
import org.cibseven.bpm.engine.history.CleanableHistoricDecisionInstanceReport;
...
import org.cibseven.bpm.engine.history.HistoricExternalTaskLogQuery;
...
import org.cibseven.bpm.engine.history.NativeHistoricActivityInstanceQuery;
import org.cibseven.bpm.engine.history.NativeHistoricCaseActivityInstanceQuery;
import org.cibseven.bpm.engine.history.NativeHistoricCaseInstanceQuery;
import org.cibseven.bpm.engine.history.NativeHistoricDecisionInstanceQuery;
import org.cibseven.bpm.engine.history.NativeHistoricProcessInstanceQuery;
import org.cibseven.bpm.engine.history.NativeHistoricTaskInstanceQuery;
import org.cibseven.bpm.engine.history.NativeHistoricVariableInstanceQuery;
...
import org.cibseven.bpm.engine.impl.cmd.DeleteHistoricCaseInstanceCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteHistoricCaseInstancesBulkCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteHistoricProcessInstancesCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteHistoricTaskInstanceCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteHistoricVariableInstanceCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteHistoricVariableInstancesByProcessInstanceIdCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteUserOperationLogEntryCmd;
import org.cibseven.bpm.engine.impl.cmd.FindHistoryCleanupJobsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetHistoricExternalTaskLogErrorDetailsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetHistoricJobLogExceptionStacktraceCmd;
import org.cibseven.bpm.engine.impl.cmd.HistoryCleanupCmd;
import org.cibseven.bpm.engine.impl.cmd.batch.DeleteHistoricProcessInstancesBatchCmd;
import org.cibseven.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByDefinitionIdCmd;
