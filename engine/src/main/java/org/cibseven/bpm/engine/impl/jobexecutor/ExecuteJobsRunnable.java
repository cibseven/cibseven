...
public class ExecuteJobsRunnable implements Runnable {
   ...
   * org.cibseven.bpm.container.impl.threading.ra.inflow.JcaInflowExecuteJobsRunnable.executeJob(String, CommandExecutor)
   */
   ...
   * org.cibseven.bpm.container.impl.threading.ra.inflow.JcaInflowExecuteJobsRunnable#switchClassLoader()
