...
import org.cibseven.bpm.engine.impl.cmd.AddCommentCmd;
import org.cibseven.bpm.engine.impl.cmd.AddGroupIdentityLinkCmd;
import org.cibseven.bpm.engine.impl.cmd.AddUserIdentityLinkCmd;
import org.cibseven.bpm.engine.impl.cmd.AssignTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.ClaimTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.CompleteTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateAttachmentCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.DelegateTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteAttachmentCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteGroupIdentityLinkCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteProcessInstanceCommentCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteTaskCommentCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteUserIdentityLinkCmd;
import org.cibseven.bpm.engine.impl.cmd.GetAttachmentCmd;
import org.cibseven.bpm.engine.impl.cmd.GetAttachmentContentCmd;
import org.cibseven.bpm.engine.impl.cmd.GetIdentityLinksForTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.GetProcessInstanceAttachmentsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetProcessInstanceCommentsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetSubTasksCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskAttachmentCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskAttachmentContentCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskAttachmentsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskCommentCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskCommentsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskEventsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskVariableCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTaskVariableCmdTyped;
import org.cibseven.bpm.engine.impl.cmd.GetTaskVariablesCmd;
import org.cibseven.bpm.engine.impl.cmd.HandleTaskBpmnErrorCmd;
import org.cibseven.bpm.engine.impl.cmd.HandleTaskEscalationCmd;
import org.cibseven.bpm.engine.impl.cmd.PatchTaskVariablesCmd;
import org.cibseven.bpm.engine.impl.cmd.RemoveTaskVariablesCmd;
import org.cibseven.bpm.engine.impl.cmd.ResolveTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.SaveAttachmentCmd;
import org.cibseven.bpm.engine.impl.cmd.SaveTaskCmd;
import org.cibseven.bpm.engine.impl.cmd.SetTaskDescriptionCmd;
import org.cibseven.bpm.engine.impl.cmd.SetTaskDueDateCmd;
import org.cibseven.bpm.engine.impl.cmd.SetTaskFollowUpDateCmd;
import org.cibseven.bpm.engine.impl.cmd.SetTaskNameCmd;
import org.cibseven.bpm.engine.impl.cmd.SetTaskOwnerCmd;
import org.cibseven.bpm.engine.impl.cmd.SetTaskPriorityCmd;
import org.cibseven.bpm.engine.impl.cmd.SetTaskVariablesCmd;
import org.cibseven.bpm.engine.impl.cmd.UpdateCommentCmd;
...
import org.cibseven.bpm.engine.task.NativeTaskQuery;
