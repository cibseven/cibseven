 ...
 */
package org.cibseven.bpm.engine.impl.db.entitymanager;

import static org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_MERGED;
import static org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_PERSISTENT;
import static org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_TRANSIENT;
import static org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityState.MERGED;
import static org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityState.PERSISTENT;
import static org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityState.TRANSIENT;
import static org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE;
import static org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE_BULK;
import static org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperationType.INSERT;
import static org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE;
import static org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE_BULK;
...
import org.cibseven.bpm.engine.impl.HistoricActivityInstanceQueryImpl;
import org.cibseven.bpm.engine.impl.HistoricDetailQueryImpl;
...
import org.cibseven.bpm.engine.impl.JobQueryImpl;
import org.cibseven.bpm.engine.impl.Page;
import org.cibseven.bpm.engine.impl.ProcessDefinitionQueryImpl;
...
import org.cibseven.bpm.engine.impl.db.FlushResult;
import org.cibseven.bpm.engine.impl.db.HistoricEntity;
...
import org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityCache;
...
import org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperation.State;
import org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperationManager;
import org.cibseven.bpm.engine.impl.db.entitymanager.operation.DbOperationType;
