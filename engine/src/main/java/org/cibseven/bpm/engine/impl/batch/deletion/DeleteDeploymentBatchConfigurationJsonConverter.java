...
public class DeleteDeploymentBatchConfigurationJsonConverter extends AbstractBatchConfigurationObjectConverter<DeleteDeploymentBatchConfiguration> {
  ...
  public static final String CASCADE = "cascade";
   public static final String SKIP_IO_MAPPINGS = "SKIP_IO_MAPPINGS";
