 ...
 * <ul>
 * <li>
 * <b>{@link org.cibseven.bpm.engine.RuntimeService}: </b> Allows the creation of
 * {@link org.cibseven.bpm.engine.repository.Deployment}s and the starting of and searching on
 * {@link org.cibseven.bpm.engine.runtime.ProcessInstance}s.</li>
 * <li>
 * <b>{@link org.cibseven.bpm.engine.TaskService}: </b> Exposes operations to manage human
 * (standalone) {@link org.cibseven.bpm.engine.task.Task}s, such as claiming, completing and
 * assigning tasks</li>
 * <li>
 * <b>{@link org.cibseven.bpm.engine.IdentityService}: </b> Used for managing
 * {@link org.cibseven.bpm.engine.identity.User}s, {@link org.cibseven.bpm.engine.identity.Group}s and
 * the relations between them<</li>
 * <li>
 * <b>{@link org.cibseven.bpm.engine.ManagementService}: </b> Exposes engine admin and
 * maintenance operations</li>
 *  <li>
 * <b>{@link org.cibseven.bpm.engine.HistoryService}: </b> Service exposing information about
 * ongoing and past process instances.</li>
 *
 * <li><b>{@link org.cibseven.bpm.engine.AuthorizationService}:</b> Service allowing
