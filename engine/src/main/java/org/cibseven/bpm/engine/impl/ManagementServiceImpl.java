...
import org.cibseven.bpm.engine.impl.batch.BatchQueryImpl;
import org.cibseven.bpm.engine.impl.batch.BatchStatisticsQueryImpl;
import org.cibseven.bpm.engine.impl.batch.DeleteBatchCmd;
import org.cibseven.bpm.engine.impl.cfg.CommandChecker;
import org.cibseven.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl;
import org.cibseven.bpm.engine.impl.cmd.ActivateBatchCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteJobCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteLicenseKeyCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteMetricsCmd;
import org.cibseven.bpm.engine.impl.cmd.DeletePropertyCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteTaskMetricsCmd;
import org.cibseven.bpm.engine.impl.cmd.GetHistoryLevelCmd;
import org.cibseven.bpm.engine.impl.cmd.GetJobExceptionStacktraceCmd;
import org.cibseven.bpm.engine.impl.cmd.GetLicenseKeyCmd;
import org.cibseven.bpm.engine.impl.cmd.GetProcessApplicationForDeploymentCmd;
import org.cibseven.bpm.engine.impl.cmd.GetPropertiesCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTableCountCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTableMetaDataCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTableNameCmd;
import org.cibseven.bpm.engine.impl.cmd.GetTelemetryDataCmd;
import org.cibseven.bpm.engine.impl.cmd.GetUniqueTaskWorkerCountCmd;
import org.cibseven.bpm.engine.impl.cmd.IsTelemetryEnabledCmd;
import org.cibseven.bpm.engine.impl.cmd.PurgeDatabaseAndCacheCmd;
import org.cibseven.bpm.engine.impl.cmd.RecalculateJobDuedateCmd;
import org.cibseven.bpm.engine.impl.cmd.RegisterDeploymentCmd;
import org.cibseven.bpm.engine.impl.cmd.RegisterProcessApplicationCmd;
import org.cibseven.bpm.engine.impl.cmd.ReportDbMetricsCmd;
import org.cibseven.bpm.engine.impl.cmd.SetJobDefinitionPriorityCmd;
import org.cibseven.bpm.engine.impl.cmd.SetJobDuedateCmd;
import org.cibseven.bpm.engine.impl.cmd.SetJobPriorityCmd;
import org.cibseven.bpm.engine.impl.cmd.SetLicenseKeyCmd;
import org.cibseven.bpm.engine.impl.cmd.SetPropertyCmd;
import org.cibseven.bpm.engine.impl.cmd.SuspendBatchCmd;
import org.cibseven.bpm.engine.impl.cmd.TelemetryConfigureCmd;
import org.cibseven.bpm.engine.impl.cmd.UnregisterDeploymentCmd;
import org.cibseven.bpm.engine.impl.cmd.UnregisterProcessApplicationCmd;
...
import org.cibseven.bpm.engine.impl.management.PurgeReport;
import org.cibseven.bpm.engine.impl.management.SetJobRetriesBuilderImpl;
import org.cibseven.bpm.engine.impl.management.SetJobRetriesByJobsAsyncBuilderImpl;
import org.cibseven.bpm.engine.impl.management.SetJobRetriesByProcessAsyncBuilderImpl;
import org.cibseven.bpm.engine.impl.management.UpdateJobDefinitionSuspensionStateBuilderImpl;
import org.cibseven.bpm.engine.impl.management.UpdateJobSuspensionStateBuilderImpl;
import org.cibseven.bpm.engine.impl.metrics.MetricsQueryImpl;
...
import org.cibseven.bpm.engine.management.SetJobRetriesByJobsAsyncBuilder;
...
import org.cibseven.bpm.engine.management.TablePageQuery;
import org.cibseven.bpm.engine.management.UpdateJobDefinitionSuspensionStateSelectBuilder;
import org.cibseven.bpm.engine.management.UpdateJobSuspensionStateSelectBuilder;
