...
public class AbstractCmmnTransformListener implements CmmnTransformListener {
  ...
  public void transformCasePlanModel(org.cibseven.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity activity) {
    transformCasePlanModel((org.cibseven.bpm.model.cmmn.instance.CasePlanModel) casePlanModel, activity);
  }
