...
import org.cibseven.bpm.engine.impl.ProcessEngineInfoImpl;
 ...
 * (<code>org.cibseven.bpm.engine.test.impl.servlet.listener.ProcessEnginesServletContextListener</code>).  That way,
...
public abstract class ProcessEngines {
  ...
  protected static void initProcessEngineFromSpringResource(URL resource) {
    try {
      Class< ? > springConfigurationHelperClass = ReflectUtil.loadClass("org.cibseven.bpm.engine.spring.SpringConfigurationHelper");
