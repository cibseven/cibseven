...
import org.cibseven.bpm.engine.impl.cmd.CheckPassword;
import org.cibseven.bpm.engine.impl.cmd.GetPasswordPolicyCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateGroupCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateGroupQueryCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateMembershipCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateNativeUserQueryCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateTenantCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateTenantGroupMembershipCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateTenantQueryCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateTenantUserMembershipCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateUserCmd;
import org.cibseven.bpm.engine.impl.cmd.CreateUserQueryCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteGroupCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteMembershipCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteTenantCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteTenantGroupMembershipCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteTenantUserMembershipCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteUserCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteUserInfoCmd;
import org.cibseven.bpm.engine.impl.cmd.DeleteUserPictureCmd;
import org.cibseven.bpm.engine.impl.cmd.GetUserAccountCmd;
import org.cibseven.bpm.engine.impl.cmd.GetUserInfoCmd;
import org.cibseven.bpm.engine.impl.cmd.GetUserInfoKeysCmd;
import org.cibseven.bpm.engine.impl.cmd.GetUserPictureCmd;
import org.cibseven.bpm.engine.impl.cmd.IsIdentityServiceReadOnlyCmd;
import org.cibseven.bpm.engine.impl.cmd.SaveGroupCmd;
import org.cibseven.bpm.engine.impl.cmd.SaveTenantCmd;
import org.cibseven.bpm.engine.impl.cmd.SaveUserCmd;
import org.cibseven.bpm.engine.impl.cmd.SetUserInfoCmd;
import org.cibseven.bpm.engine.impl.cmd.SetUserPictureCmd;
import org.cibseven.bpm.engine.impl.cmd.UnlockUserCmd;
import org.cibseven.bpm.engine.impl.identity.Account;
import org.cibseven.bpm.engine.impl.identity.Authentication;
import org.cibseven.bpm.engine.impl.identity.PasswordPolicyResultImpl;
