...
import org.cibseven.bpm.engine.impl.bpmn.parser.EventSubscriptionDeclaration;
...
import org.cibseven.bpm.engine.impl.core.variable.scope.VariableCollectionProvider;
...
import org.cibseven.bpm.engine.impl.core.variable.scope.VariableListenerInvocationListener;
...
import org.cibseven.bpm.engine.impl.tree.ExecutionTopDownWalker;
import org.cibseven.bpm.engine.impl.tree.TreeVisitor;
import org.cibseven.bpm.engine.impl.util.BitMaskUtil;
...
public class ExecutionEntity extends PvmExecutionImpl implements Execution, ProcessInstance, DbEntity, HasDbRevision, HasDbReferences, VariablesProvider<VariableInstanceEntity> {
  ...
  public ExecutionEntity createExecution() {
    ...
    // sink has to travel with it or it would never fire for a scope. Harmless otherwise: it is null
    // unless a command is currently waiting for one specific id, and it clears itself on first use.
