...
public interface CmmnTransformListener {
  ...
  /**
   * @deprecated use {@link #transformCasePlanModel(org.cibseven.bpm.model.cmmn.instance.CasePlanModel, CmmnActivity)}
   */
  @Deprecated
  void transformCasePlanModel(org.cibseven.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity caseActivity);
