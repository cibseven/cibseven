 ...
 */
package org.cibseven.bpm.engine.impl.cmmn.transformer;
...
import org.cibseven.bpm.engine.impl.core.transformer.Transform;
...
import org.cibseven.bpm.model.cmmn.CmmnModelException;
...
import org.cibseven.bpm.model.cmmn.instance.PlanFragment;
...
public class CmmnTransform implements Transform<CaseDefinitionEntity> {
  ...
  protected void transformCasePlanModel(CasePlanModel casePlanModel) {
    ...
    for (CmmnTransformListener transformListener : transformListeners) {
      transformListener.transformCasePlanModel((org.cibseven.bpm.model.cmmn.impl.instance.CasePlanModel) casePlanModel, newActivity);
    }
  }
