...
import org.cibseven.bpm.engine.ArtifactFactory;
...
import org.cibseven.bpm.engine.impl.HistoryServiceImpl;
import org.cibseven.bpm.engine.impl.IdentityServiceImpl;
import org.cibseven.bpm.engine.impl.ManagementServiceImpl;
import org.cibseven.bpm.engine.impl.ModificationBatchJobHandler;
...
import org.cibseven.bpm.engine.impl.RepositoryServiceImpl;
import org.cibseven.bpm.engine.impl.RestartProcessInstancesJobHandler;
...
import org.cibseven.bpm.engine.impl.batch.job.SetJobRetriesJobHandler;
import org.cibseven.bpm.engine.impl.batch.message.MessageCorrelationBatchJobHandler;
import org.cibseven.bpm.engine.impl.batch.removaltime.BatchSetRemovalTimeJobHandler;
import org.cibseven.bpm.engine.impl.batch.removaltime.DecisionSetRemovalTimeJobHandler;
import org.cibseven.bpm.engine.impl.batch.removaltime.ProcessSetRemovalTimeJobHandler;
import org.cibseven.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateJobHandler;
import org.cibseven.bpm.engine.impl.batch.variables.BatchSetVariablesHandler;
import org.cibseven.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import org.cibseven.bpm.engine.impl.bpmn.deployer.BpmnDeployer;
...
import org.cibseven.bpm.engine.impl.calendar.BusinessCalendarManager;
import org.cibseven.bpm.engine.impl.calendar.CycleBusinessCalendar;
import org.cibseven.bpm.engine.impl.calendar.DueDateBusinessCalendar;
import org.cibseven.bpm.engine.impl.calendar.DurationBusinessCalendar;
import org.cibseven.bpm.engine.impl.calendar.MapBusinessCalendarManager;
import org.cibseven.bpm.engine.impl.cfg.auth.AuthorizationCommandChecker;
...
import org.cibseven.bpm.engine.impl.cfg.auth.ResourceAuthorizationProvider;
import org.cibseven.bpm.engine.impl.cfg.multitenancy.TenantCommandChecker;
...
import org.cibseven.bpm.engine.impl.cmd.HistoryCleanupCmd;
import org.cibseven.bpm.engine.impl.cmmn.CaseServiceImpl;
import org.cibseven.bpm.engine.impl.cmmn.deployer.CmmnDeployer;
import org.cibseven.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionManager;
import org.cibseven.bpm.engine.impl.cmmn.entity.runtime.CaseExecutionManager;
import org.cibseven.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartManager;
import org.cibseven.bpm.engine.impl.cmmn.handler.DefaultCmmnElementHandlerRegistry;
import org.cibseven.bpm.engine.impl.cmmn.transformer.CmmnTransformFactory;
import org.cibseven.bpm.engine.impl.cmmn.transformer.CmmnTransformListener;
import org.cibseven.bpm.engine.impl.cmmn.transformer.CmmnTransformer;
import org.cibseven.bpm.engine.impl.cmmn.transformer.DefaultCmmnTransformFactory;
import org.cibseven.bpm.engine.impl.db.DbIdGenerator;
import org.cibseven.bpm.engine.impl.db.entitymanager.DbEntityManagerFactory;
import org.cibseven.bpm.engine.impl.db.entitymanager.cache.DbEntityCacheKeyMapping;
import org.cibseven.bpm.engine.impl.db.sql.DbSqlPersistenceProviderFactory;
import org.cibseven.bpm.engine.impl.db.sql.DbSqlSessionFactory;
import org.cibseven.bpm.engine.impl.delegate.DefaultDelegateInterceptor;
import org.cibseven.bpm.engine.impl.diagnostics.DiagnosticsCollector;
import org.cibseven.bpm.engine.impl.diagnostics.DiagnosticsRegistry;
import org.cibseven.bpm.engine.impl.digest.Default16ByteSaltGenerator;
import org.cibseven.bpm.engine.impl.digest.PasswordEncryptor;
import org.cibseven.bpm.engine.impl.digest.PasswordManager;
import org.cibseven.bpm.engine.impl.digest.SaltGenerator;
import org.cibseven.bpm.engine.impl.digest.Sha512HashDigest;
import org.cibseven.bpm.engine.impl.dmn.batch.DeleteHistoricDecisionInstancesJobHandler;
import org.cibseven.bpm.engine.impl.dmn.configuration.DmnEngineConfigurationBuilder;
import org.cibseven.bpm.engine.impl.dmn.deployer.DecisionDefinitionDeployer;
import org.cibseven.bpm.engine.impl.dmn.deployer.DecisionRequirementsDefinitionDeployer;
import org.cibseven.bpm.engine.impl.dmn.entity.repository.DecisionDefinitionManager;
import org.cibseven.bpm.engine.impl.dmn.entity.repository.DecisionRequirementsDefinitionManager;
import org.cibseven.bpm.engine.impl.el.CommandContextFunctions;
import org.cibseven.bpm.engine.impl.el.DateTimeFunctions;
import org.cibseven.bpm.engine.impl.el.ElProviderCompatible;
...
import org.cibseven.bpm.engine.impl.event.ConditionalEventHandler;
import org.cibseven.bpm.engine.impl.event.EventHandler;
import org.cibseven.bpm.engine.impl.event.EventHandlerImpl;
import org.cibseven.bpm.engine.impl.event.EventType;
import org.cibseven.bpm.engine.impl.event.SignalEventHandler;
import org.cibseven.bpm.engine.impl.externaltask.DefaultExternalTaskPriorityProvider;
import org.cibseven.bpm.engine.impl.form.deployer.CamundaFormDefinitionDeployer;
import org.cibseven.bpm.engine.impl.form.engine.FormEngine;
import org.cibseven.bpm.engine.impl.form.engine.HtmlFormEngine;
import org.cibseven.bpm.engine.impl.form.engine.JuelFormEngine;
...
import org.cibseven.bpm.engine.impl.form.type.BooleanFormType;
import org.cibseven.bpm.engine.impl.form.type.DateFormType;
import org.cibseven.bpm.engine.impl.form.type.FormTypes;
import org.cibseven.bpm.engine.impl.form.type.LongFormType;
...
import org.cibseven.bpm.engine.impl.form.validator.FormValidators;
import org.cibseven.bpm.engine.impl.form.validator.MaxLengthValidator;
import org.cibseven.bpm.engine.impl.form.validator.MaxValidator;
import org.cibseven.bpm.engine.impl.form.validator.MinLengthValidator;
import org.cibseven.bpm.engine.impl.form.validator.MinValidator;
import org.cibseven.bpm.engine.impl.form.validator.ReadOnlyValidator;
import org.cibseven.bpm.engine.impl.form.validator.RequiredValidator;
...
import org.cibseven.bpm.engine.impl.history.HistoryRemovalTimeProvider;
import org.cibseven.bpm.engine.impl.history.event.HistoricDecisionInstanceManager;
import org.cibseven.bpm.engine.impl.history.event.HostnameProvider;
import org.cibseven.bpm.engine.impl.history.event.SimpleIpBasedProvider;
...
import org.cibseven.bpm.engine.impl.history.parser.HistoryParseListener;
import org.cibseven.bpm.engine.impl.history.producer.CacheAwareCmmnHistoryEventProducer;
import org.cibseven.bpm.engine.impl.history.producer.CacheAwareHistoryEventProducer;
import org.cibseven.bpm.engine.impl.history.producer.CmmnHistoryEventProducer;
import org.cibseven.bpm.engine.impl.history.producer.DefaultDmnHistoryEventProducer;
import org.cibseven.bpm.engine.impl.history.producer.DmnHistoryEventProducer;
import org.cibseven.bpm.engine.impl.history.producer.HistoryEventProducer;
import org.cibseven.bpm.engine.impl.history.transformer.CmmnHistoryTransformListener;
...
import org.cibseven.bpm.engine.impl.identity.db.DbIdentityServiceProvider;
import org.cibseven.bpm.engine.impl.incident.CompositeIncidentHandler;
...
import org.cibseven.bpm.engine.impl.interceptor.CommandExecutorImpl;
import org.cibseven.bpm.engine.impl.interceptor.CommandInterceptor;
import org.cibseven.bpm.engine.impl.interceptor.DelegateInterceptor;
import org.cibseven.bpm.engine.impl.interceptor.ExceptionCodeInterceptor;
...
import org.cibseven.bpm.engine.impl.jobexecutor.FailedJobCommandFactory;
...
import org.cibseven.bpm.engine.impl.jobexecutor.NotifyAcquisitionRejectedJobsHandler;
import org.cibseven.bpm.engine.impl.jobexecutor.ProcessEventJobHandler;
import org.cibseven.bpm.engine.impl.jobexecutor.RejectedJobsHandler;
import org.cibseven.bpm.engine.impl.jobexecutor.TimerActivateJobDefinitionHandler;
import org.cibseven.bpm.engine.impl.jobexecutor.TimerActivateProcessDefinitionHandler;
...
import org.cibseven.bpm.engine.impl.jobexecutor.TimerStartEventJobHandler;
import org.cibseven.bpm.engine.impl.jobexecutor.TimerStartEventSubprocessJobHandler;
import org.cibseven.bpm.engine.impl.jobexecutor.TimerSuspendJobDefinitionHandler;
...
import org.cibseven.bpm.engine.impl.jobexecutor.historycleanup.DefaultBatchWindowManager;
import org.cibseven.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupBatch;
import org.cibseven.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHandler;
...
import org.cibseven.bpm.engine.impl.metrics.MetricsRegistry;
import org.cibseven.bpm.engine.impl.metrics.MetricsReporterIdProvider;
import org.cibseven.bpm.engine.impl.metrics.parser.MetricsBpmnParseListener;
import org.cibseven.bpm.engine.impl.metrics.parser.MetricsCmmnTransformListener;
import org.cibseven.bpm.engine.impl.metrics.reporter.DbMetricsReporter;
import org.cibseven.bpm.engine.impl.migration.DefaultMigrationActivityMatcher;
import org.cibseven.bpm.engine.impl.migration.DefaultMigrationInstructionGenerator;
...
import org.cibseven.bpm.engine.impl.migration.batch.MigrationBatchJobHandler;
import org.cibseven.bpm.engine.impl.migration.validation.activity.MigrationActivityValidator;
import org.cibseven.bpm.engine.impl.migration.validation.activity.NoCompensationHandlerActivityValidator;
import org.cibseven.bpm.engine.impl.migration.validation.activity.SupportedActivityValidator;
import org.cibseven.bpm.engine.impl.migration.validation.activity.SupportedPassiveEventTriggerActivityValidator;
import org.cibseven.bpm.engine.impl.migration.validation.instance.AsyncAfterMigrationValidator;
import org.cibseven.bpm.engine.impl.migration.validation.instance.AsyncMigrationValidator;
import org.cibseven.bpm.engine.impl.migration.validation.instance.AsyncProcessStartMigrationValidator;
import org.cibseven.bpm.engine.impl.migration.validation.instance.MigratingActivityInstanceValidator;
import org.cibseven.bpm.engine.impl.migration.validation.instance.MigratingCompensationInstanceValidator;
...
import org.cibseven.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceBodyValidator;
...
import org.cibseven.bpm.engine.impl.migration.validation.instruction.ConditionalEventUpdateEventTriggerValidator;
...
import org.cibseven.bpm.engine.impl.optimize.OptimizeManager;
import org.cibseven.bpm.engine.impl.persistence.GenericManagerFactory;
import org.cibseven.bpm.engine.impl.persistence.deploy.Deployer;
import org.cibseven.bpm.engine.impl.persistence.deploy.cache.CacheFactory;
import org.cibseven.bpm.engine.impl.persistence.deploy.cache.DefaultCacheFactory;
import org.cibseven.bpm.engine.impl.persistence.deploy.cache.DeploymentCache;
import org.cibseven.bpm.engine.impl.persistence.entity.AttachmentManager;
import org.cibseven.bpm.engine.impl.persistence.entity.AuthorizationManager;
import org.cibseven.bpm.engine.impl.persistence.entity.BatchManager;
import org.cibseven.bpm.engine.impl.persistence.entity.ByteArrayManager;
import org.cibseven.bpm.engine.impl.persistence.entity.CommentManager;
import org.cibseven.bpm.engine.impl.persistence.entity.DeploymentManager;
...
import org.cibseven.bpm.engine.impl.persistence.entity.FilterManager;
import org.cibseven.bpm.engine.impl.persistence.entity.HistoricActivityInstanceManager;
import org.cibseven.bpm.engine.impl.persistence.entity.HistoricBatchManager;
import org.cibseven.bpm.engine.impl.persistence.entity.HistoricCaseActivityInstanceManager;
import org.cibseven.bpm.engine.impl.persistence.entity.HistoricCaseInstanceManager;
...
import org.cibseven.bpm.engine.impl.persistence.entity.HistoricStatisticsManager;
import org.cibseven.bpm.engine.impl.persistence.entity.HistoricTaskInstanceManager;
import org.cibseven.bpm.engine.impl.persistence.entity.HistoricVariableInstanceManager;
import org.cibseven.bpm.engine.impl.persistence.entity.IdentityInfoManager;
import org.cibseven.bpm.engine.impl.persistence.entity.IdentityLinkManager;
import org.cibseven.bpm.engine.impl.persistence.entity.IncidentManager;
...
import org.cibseven.bpm.engine.impl.persistence.entity.MeterLogManager;
import org.cibseven.bpm.engine.impl.persistence.entity.ProcessDefinitionManager;
import org.cibseven.bpm.engine.impl.persistence.entity.PropertyManager;
import org.cibseven.bpm.engine.impl.persistence.entity.ReportManager;
import org.cibseven.bpm.engine.impl.persistence.entity.ResourceManager;
import org.cibseven.bpm.engine.impl.persistence.entity.SchemaLogManager;
import org.cibseven.bpm.engine.impl.persistence.entity.StatisticsManager;
import org.cibseven.bpm.engine.impl.persistence.entity.TableDataManager;
import org.cibseven.bpm.engine.impl.persistence.entity.TaskManager;
import org.cibseven.bpm.engine.impl.persistence.entity.TaskReportManager;
import org.cibseven.bpm.engine.impl.persistence.entity.TenantManager;
import org.cibseven.bpm.engine.impl.persistence.entity.UserOperationLogManager;
import org.cibseven.bpm.engine.impl.persistence.entity.VariableInstanceManager;
import org.cibseven.bpm.engine.impl.repository.DefaultDeploymentHandlerFactory;
import org.cibseven.bpm.engine.impl.runtime.ConditionHandler;
import org.cibseven.bpm.engine.impl.runtime.CorrelationHandler;
import org.cibseven.bpm.engine.impl.runtime.DefaultConditionHandler;
import org.cibseven.bpm.engine.impl.runtime.DefaultCorrelationHandler;
import org.cibseven.bpm.engine.impl.runtime.DefaultDeserializationTypeValidator;
import org.cibseven.bpm.engine.impl.scripting.ScriptFactory;
import org.cibseven.bpm.engine.impl.scripting.engine.BeansResolverFactory;
...
import org.cibseven.bpm.engine.impl.scripting.engine.VariableScopeResolverFactory;
...
import org.cibseven.bpm.engine.impl.telemetry.dto.DatabaseImpl;
import org.cibseven.bpm.engine.impl.telemetry.dto.InternalsImpl;
import org.cibseven.bpm.engine.impl.telemetry.dto.JdkImpl;
import org.cibseven.bpm.engine.impl.telemetry.dto.ProductImpl;
...
import org.cibseven.bpm.engine.impl.variable.serializer.BooleanValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.ByteArrayValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.DateValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.DefaultVariableSerializers;
import org.cibseven.bpm.engine.impl.variable.serializer.DoubleValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.FileValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.IntegerValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.JavaObjectSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.LongValueSerlializer;
import org.cibseven.bpm.engine.impl.variable.serializer.NullValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.ShortValueSerializer;
import org.cibseven.bpm.engine.impl.variable.serializer.StringValueSerializer;
...
import org.cibseven.bpm.engine.repository.DeploymentHandlerFactory;
...
import org.cibseven.bpm.engine.test.mock.MocksResolverFactory;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
  ...
  public static final String DEFAULT_WS_SYNC_FACTORY = "org.cibseven.bpm.engine.impl.webservice.CxfWebServiceClientFactory";

  public static final String DEFAULT_MYBATIS_MAPPING_FILE = "org/cibseven/bpm/engine/impl/mapping/mappings.xml";
  ...
  /**
   * As an instance of {@link org.cibseven.bpm.engine.impl.history.handler.CompositeHistoryEventHandler}
  ...
  /**
   * If true (default), the {@link org.cibseven.bpm.engine.impl.ExpressionWhitelistValidator} restricts
   * expressions in task filter criteria and adhoc task queries to {@link #allowedFilterExpressions}.
   * Set to false to disable the validator entirely and allow any expression.
   */
    ...
    synchronized (ProcessEngineConfigurationImpl.class) {
      ...
      if (sqlSessionFactory == null) {
        ...
        try {
          ...
          if (isUseSharedSqlSessionFactory) {
            properties.put("prefix", "${@org.cibseven.bpm.engine.impl.context.Context@getProcessEngineConfiguration().databaseTablePrefix}");
          } else {
