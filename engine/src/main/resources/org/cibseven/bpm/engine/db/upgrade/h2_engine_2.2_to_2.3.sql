...
-- Modeler: folders for diagrams and forms, and the move of a flat installation into one of them.
-- The ids of the two folders are fixed so the statements need no UUID function.
