...
INSERT INTO MOD_FOLDERS (ID, PARENT_ID, SOURCE, NAME, CREATED)
    VALUES ('00000000-0000-0000-0000-0000000000d1', NULL, 'DATABASE', 'DATABASE', SYSTIMESTAMP);
INSERT INTO MOD_FOLDERS (ID, PARENT_ID, SOURCE, NAME, CREATED)
    VALUES ('00000000-0000-0000-0000-0000000000d2', '00000000-0000-0000-0000-0000000000d1', 'DATABASE', 'General', SYSTIMESTAMP);
