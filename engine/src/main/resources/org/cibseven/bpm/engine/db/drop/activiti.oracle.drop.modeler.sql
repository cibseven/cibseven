...
DROP INDEX NOTIF_IDX_GROUPS_GROUP;
DROP TABLE NOTIFICATION_GROUPS;
DROP INDEX NOTIF_IDX_NOTIFICATIONS_ACTIVE;
...
DROP TABLE MOD_FORMS_AUD CASCADE CONSTRAINTS;
...
DROP INDEX MOD_IDX_FOLDERS_PARENT;
DROP TABLE MOD_FOLDERS CASCADE CONSTRAINTS;
