...
DROP INDEX NOTIF_IDX_GROUPS_GROUP ON NOTIFICATION_GROUPS;
DROP TABLE NOTIFICATION_GROUPS;
DROP INDEX NOTIF_IDX_NOTIFICATIONS_ACTIVE ON NOTIFICATIONS;
...
IF OBJECT_ID('MOD_FORMS_AUD', 'U') IS NOT NULL DROP TABLE MOD_FORMS_AUD;
...
DROP INDEX MOD_IDX_FOLDERS_PARENT ON MOD_FOLDERS;
IF OBJECT_ID('MOD_FOLDERS', 'U') IS NOT NULL DROP TABLE MOD_FOLDERS;
