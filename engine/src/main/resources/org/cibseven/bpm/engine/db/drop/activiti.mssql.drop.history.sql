...
drop index ACT_HI_AGENT_AUDIT.ACT_IDX_HI_AGENT_RUN;
drop index ACT_HI_AGENT_AUDIT.ACT_IDX_HI_AGENT_PI;
drop index ACT_HI_AGENT_AUDIT.ACT_IDX_HI_AGENT_ROOT_PI;
drop index ACT_HI_AGENT_AUDIT.ACT_IDX_HI_AGENT_TYPE;
drop index ACT_HI_AGENT_AUDIT.ACT_IDX_HI_AGENT_RM_TIME;
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_HI_AGENT_AUDIT') drop table ACT_HI_AGENT_AUDIT;
