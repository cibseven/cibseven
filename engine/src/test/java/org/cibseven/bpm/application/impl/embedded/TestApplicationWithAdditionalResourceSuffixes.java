 ...
 */
package org.cibseven.bpm.application.impl.embedded;
...
@ProcessApplication(
    name="test-app",
    deploymentDescriptors={"org/cibseven/bpm/application/impl/embedded/deployment-with-additional-resource-suffixes.xml"}
)
