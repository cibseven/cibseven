...
public class ErrorEndEventTest {
  ...
  @Test
  @Deployment(resources = { "org/cibseven/bpm/engine/test/bpmn/event/error/testPropagateOutputVariablesWhileThrowError.bpmn20.xml",
                            "org/cibseven/bpm/engine/test/bpmn/event/error/ErrorEventTest.errorParent.bpmn20.xml" })
