...
//  public RuleChain ruleChain = RuleChain.outerRule(testRule).around(engineRule);
  ...
  public void setUp() {
    ...
    testRule.deploy("org/cibseven/bpm/engine/test/repository/one.dmn");
  }
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("org/cibseven/bpm/engine/test/repository/two.dmn", "org/cibseven/bpm/engine/test/api/dmn/Another_Example.dmn",
