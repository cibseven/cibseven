...
import org.cibseven.bpm.engine.test.api.runtime.BatchModificationHelper;
...
public class HistoryCleanupHistoricBatchTest {
  ...
  @RegisterExtension
  @Order (4) protected MigrationTestRule migrationRule = new MigrationTestRule(engineRule);
