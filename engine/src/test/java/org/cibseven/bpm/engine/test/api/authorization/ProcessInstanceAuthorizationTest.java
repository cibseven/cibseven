...
import static org.cibseven.bpm.engine.authorization.ProcessDefinitionPermissions.UPDATE_INSTANCE_VARIABLE;
import static org.cibseven.bpm.engine.authorization.ProcessInstancePermissions.SUSPEND;
import static org.cibseven.bpm.engine.authorization.ProcessInstancePermissions.UPDATE_VARIABLE;
...
public class ProcessInstanceAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    testRule.deploy(
        ...
        "org/cibseven/bpm/engine/test/api/authorization/messageStartEventProcess.bpmn20.xml",
        "org/cibseven/bpm/engine/test/api/authorization/messageBoundaryEventProcess.bpmn20.xml",
        "org/cibseven/bpm/engine/test/api/authorization/signalBoundaryEventProcess.bpmn20.xml",
        "org/cibseven/bpm/engine/test/api/authorization/signalStartEventProcess.bpmn20.xml",
        "org/cibseven/bpm/engine/test/api/authorization/throwWarningSignalEventProcess.bpmn20.xml",
        "org/cibseven/bpm/engine/test/api/authorization/throwAlertSignalEventProcess.bpmn20.xml"
        );
