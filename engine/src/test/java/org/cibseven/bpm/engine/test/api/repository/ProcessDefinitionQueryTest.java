...
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.processDefinitionByDeployTime;
...
public class ProcessDefinitionQueryTest extends AbstractDefinitionQueryTest {
  ...
  protected String getResourceOnePath() {
    return "org/cibseven/bpm/engine/test/repository/one.bpmn20.xml";
  }

  protected String getResourceTwoPath() {
    return "org/cibseven/bpm/engine/test/repository/two.bpmn20.xml";
  }

  protected String getResourceThreePath() {
    return "org/cibseven/bpm/engine/test/repository/three_.bpmn20.xml";
  }
  ...
  public void testQueryByMessageSubscription() {
    Deployment deployment = repositoryService.createDeployment()
      .addClasspathResource("org/cibseven/bpm/engine/test/api/repository/processWithNewBookingMessage.bpmn20.xml")
      .addClasspathResource("org/cibseven/bpm/engine/test/api/repository/processWithNewInvoiceMessage.bpmn20.xml")
    .deploy();
  ...
  @Test
  @org.cibseven.bpm.engine.test.Deployment(resources={"org/cibseven/bpm/engine/test/api/repository/failingProcessCreateOneIncident.bpmn20.xml"})
  ...
  public void testQueryByLatestAndName() {
    String firstDeployment = repositoryService
        .createDeployment()
        .addClasspathResource("org/cibseven/bpm/engine/test/api/repository/first-process.bpmn20.xml")
        .deploy()
        .getId();
  ...
  public void testQueryByLatestAndName_NotFound() {
    ...
    String secondDeployment = repositoryService
        .createDeployment()
        .addClasspathResource("org/cibseven/bpm/engine/test/api/repository/second-process.bpmn20.xml")
        .deploy()
        .getId();
  ...
  @org.cibseven.bpm.engine.test.Deployment(resources={
    ...
    "org/cibseven/bpm/engine/test/api/repository/VersionTagTest.testParsingVersionTag.bpmn20.xml"
  })
