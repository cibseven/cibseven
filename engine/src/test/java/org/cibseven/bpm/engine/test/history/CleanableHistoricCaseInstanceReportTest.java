...
public class CleanableHistoricCaseInstanceReportTest {
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("org/cibseven/bpm/engine/test/api/cmmn/oneCaseTaskCase.cmmn", "org/cibseven/bpm/engine/test/api/cmmn/oneTaskCase.cmmn",
        "org/cibseven/bpm/engine/test/api/cmmn/oneTaskCaseWithHistoryTimeToLive.cmmn");
