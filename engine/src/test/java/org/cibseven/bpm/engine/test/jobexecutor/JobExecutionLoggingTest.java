...
import org.cibseven.bpm.engine.impl.jobexecutor.CallerRunsRejectedJobsHandler;
...
public class JobExecutionLoggingTest {
  ...
  @Test
  @Deployment(resources = { "org/cibseven/bpm/engine/test/jobexecutor/SimpleAsyncDelayProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "org/cibseven/bpm/engine/test/jobexecutor/delegateThrowsException.bpmn20.xml" })
