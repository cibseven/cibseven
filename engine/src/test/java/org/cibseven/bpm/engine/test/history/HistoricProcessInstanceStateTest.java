...
public class HistoricProcessInstanceStateTest {
  ...
  @Test
  @Deployment(resources = {"org/cibseven/bpm/engine/test/history/HistoricProcessInstanceStateTest.testWithCallActivity.bpmn"})
  ...
  @Test
  @Deployment(resources = {"org/cibseven/bpm/engine/test/history/CAM-9934.bpmn"})
