...
public class ExecutionVariablesTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/cibseven/bpm/engine/test/api/variables/ExecutionVariablesTest.testTreeCompactionWithLocalVariableOnConcurrentExecution.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = "org/cibseven/bpm/engine/test/api/variables/ExecutionVariablesTest.testTreeCompactionForkParallelGateway.bpmn20.xml")
  @Test
