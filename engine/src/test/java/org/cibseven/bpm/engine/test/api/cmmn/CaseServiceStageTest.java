...
public class CaseServiceStageTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"org/cibseven/bpm/engine/test/api/cmmn/oneStageCase.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/cibseven/bpm/engine/test/api/cmmn/oneStageCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources={"org/cibseven/bpm/engine/test/api/cmmn/oneTaskAndOneStageCase.cmmn"})
  @Test
