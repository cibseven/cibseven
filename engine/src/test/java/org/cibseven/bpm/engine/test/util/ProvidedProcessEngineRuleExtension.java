...
public class ProvidedProcessEngineRuleExtension implements AfterEachCallback, BeforeEachCallback, TestInstancePostProcessor {

	protected ProvidedProcessEngineRule engineRule;
	protected ProcessEngineTestRule testRule;

	public ProvidedProcessEngineRuleExtension() {
