...
import org.cibseven.bpm.engine.test.dmn.feel.helper.CustomFunctionProvider;
...
public class FeelCustomFunctionConfigTest {
  ...
  @Test
  @Deployment(resources = {"org/cibseven/bpm/engine/test/dmn/feel/custom_function.dmn"})
