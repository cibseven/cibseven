 ...
 */
package org.cibseven.bpm.engine.test.standalone.db.entitymanager;

import static org.cibseven.bpm.engine.authorization.Authorization.ANY;
import static org.cibseven.bpm.engine.authorization.Authorization.AUTH_TYPE_GLOBAL;
import static org.cibseven.bpm.engine.authorization.Authorization.AUTH_TYPE_GRANT;
import static org.cibseven.bpm.engine.impl.test.TestHelper.assertAndEnsureCleanDbAndCache;
...
import org.cibseven.bpm.engine.impl.management.DatabasePurgeReport;
import org.cibseven.bpm.engine.impl.management.PurgeReport;
import org.cibseven.bpm.engine.impl.persistence.deploy.cache.CachePurgeReport;
...
//  @Rule
  ...
  public void testPurgeCmmnProcess() {
    ...
    engineRule.getRepositoryService()
      .createDeployment()
      .addClasspathResource("org/cibseven/bpm/engine/test/standalone/db/entitymanager/PurgeDatabaseTest.testPurgeCmmnProcess.cmmn")
      .deploy();
    VariableMap variables = Variables.createVariables();
    variables.put("key", "value");
  ...
  public void testPurgeDmnProcess() {
    ...
    engineRule.getRepositoryService()
      .createDeployment()
      .addClasspathResource("org/cibseven/bpm/engine/test/standalone/db/entitymanager/PurgeDatabaseTest.testPurgeDmnProcess.dmn")
      .deploy();
    VariableMap variables = Variables.createVariables()
      .putValue("key", "value")
