...
public class DeploymentAwareJobExecutorTest extends PluggableProcessEngineTest {
  ...
  public void testProcessingOfJobsWithMatchingDeployment() {
    ...
    String otherDeploymentId =
        deployAndInstantiateWithNewEngineConfiguration(
            "org/cibseven/bpm/engine/test/jobexecutor/simpleAsyncProcessVersion2.bpmn20.xml");
  ...
  @Deployment(resources="org/cibseven/bpm/engine/test/jobexecutor/processWithTimerCatch.bpmn20.xml")
  @Test
  ...
  @Deployment(resources="org/cibseven/bpm/engine/test/jobexecutor/processWithTimerStart.bpmn20.xml")
  @Test
