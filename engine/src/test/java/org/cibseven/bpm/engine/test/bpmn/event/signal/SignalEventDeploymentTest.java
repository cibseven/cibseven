...
public class SignalEventDeploymentTest extends PluggableProcessEngineTest {
  ...
  private static final String SIGNAL_START_EVENT_PROCESS = "org/cibseven/bpm/engine/test/bpmn/event/signal/SignalEventTest.signalStartEvent.bpmn20.xml";
  private static final String SIGNAL_START_EVENT_PROCESS_NEW_VERSION = "org/cibseven/bpm/engine/test/bpmn/event/signal/SignalEventTest.signalStartEvent_v2.bpmn20.xml";
  ...
  public void testAsyncSignalStartEventDeleteDeploymentWhileAsync() {
    ...
    org.cibseven.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("org/cibseven/bpm/engine/test/bpmn/event/signal/SignalEventTest.signalStartEvent.bpmn20.xml")
          .addClasspathResource("org/cibseven/bpm/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignalAsync.bpmn20.xml")
          .deploy();
