...
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.jobByPriority;
...
public class JobQueryByPriorityTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "org/cibseven/bpm/engine/test/api/mgmt/jobPrioExpressionProcess.bpmn20.xml")
  @Test
