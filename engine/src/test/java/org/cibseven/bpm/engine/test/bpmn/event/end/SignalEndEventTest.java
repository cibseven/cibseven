...
public class SignalEndEventTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "org/cibseven/bpm/engine/test/bpmn/event/end/SignalEndEventTest.catchSignalEndEvent.bpmn20.xml",
      "org/cibseven/bpm/engine/test/bpmn/event/end/SignalEndEventTest.processWithSignalEndEvent.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = { "org/cibseven/bpm/engine/test/bpmn/event/signal/testPropagateOutputVariablesWhileThrowSignal.bpmn20.xml",
                            "org/cibseven/bpm/engine/test/bpmn/event/signal/SignalEndEventTest.parent.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "org/cibseven/bpm/engine/test/bpmn/event/signal/testPropagateOutputVariablesWhileThrowSignal2.bpmn20.xml",
                            "org/cibseven/bpm/engine/test/bpmn/event/signal/SignalEndEventTest.parent.bpmn20.xml" })
  @Test
