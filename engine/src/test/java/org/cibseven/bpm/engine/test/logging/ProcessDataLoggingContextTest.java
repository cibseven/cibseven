...
//TODO: Needs ExtendsWith or RegisterExtension to 
// replace @ClassRule and @Rule with JUnit 5 equivalents
public class ProcessDataLoggingContextTest {
  ...
  private static final String CMD_LOGGER = "org.cibseven.bpm.engine.cmd";
  private static final String CONTEXT_LOGGER = "org.cibseven.bpm.engine.context";
  private static final String JOBEXEC_LOGGER = "org.cibseven.bpm.engine.jobexecutor";
  private static final String PVM_LOGGER = "org.cibseven.bpm.engine.pvm";
...
//  @Rule
  ...
  public void shouldLogFailureFromEventSubprocessInSubprocessTaskContext() {
    // given
    testRule.deployForTenant(TENANT_ID, "org/cibseven/bpm/engine/test/logging/ProcessDataLoggingContextTest.shouldLogFailureFromEventSubprocessInSubprocessTaskContext.bpmn20.xml");
