...
import org.cibseven.bpm.engine.impl.cmmn.transformer.CmmnTransform;
...
public class CmmnTransformerTest {
  ...
  protected List<CaseDefinitionEntity> transform() {
    ...
    byte[] model = org.cibseven.bpm.engine.impl.util.IoUtil.readInputStream(inputStream, "model");
