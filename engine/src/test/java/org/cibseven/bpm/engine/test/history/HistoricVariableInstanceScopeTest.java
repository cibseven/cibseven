...
public class HistoricVariableInstanceScopeTest extends PluggableProcessEngineTest {
  ...
  public void testSetVariableOnProcessIntanceStartAndSetVariableLocalOnUserTask() {
    ...
    assertEquals("testVar", firstVar.getName());
    ...
    assertEquals("testVar", secondVar.getName());
  ...
  @Deployment(resources={"org/cibseven/bpm/engine/test/api/oneSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/cibseven/bpm/engine/test/history/HistoricVariableInstanceScopeTest.testSetVariableLocalOnTaskInsideParallelBranch.bpmn"})
  @Test
