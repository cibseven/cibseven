...
import org.cibseven.bpm.engine.SuspendedEntityInteractionException;
...
public class ProcessInstanceSuspensionTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
          "org/cibseven/bpm/engine/test/api/runtime/superProcessWithMultipleNestedSubProcess.bpmn20.xml",
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/runtime/ProcessInstanceSuspensionTest.testChildExecutionsSuspendedAfterProcessInstanceSuspend.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/runtime/ProcessInstanceSuspensionTest.testMessageEventReceiveFailAfterSuspend.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/runtime/ProcessInstanceSuspensionTest.testSignalEventReceivedAfterProcessInstanceSuspended.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/runtime/ProcessInstanceSuspensionTest.testJobNotExecutedAfterProcessInstanceSuspend.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/runtime/ProcessInstanceSuspensionTest.callSimpleProcess.bpmn20.xml",
      "org/cibseven/bpm/engine/test/api/runtime/subProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/runtime/ProcessInstanceSuspensionTest.callMISimpleProcess.bpmn20.xml",
  "org/cibseven/bpm/engine/test/api/runtime/subProcess.bpmn20.xml"})
  @Test
