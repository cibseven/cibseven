...
public class ExternalScriptTaskTest extends PluggableProcessEngineTest {
  ...
  public void testDefaultExternalScriptAsVariable() {
    ...
    variables.put("scriptPath", "org/cibseven/bpm/engine/test/bpmn/scripttask/greeting.py");
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/bpmn/scripttask/ExternalScriptTaskTest.testDefaultExternalScriptAsVariable.bpmn20.xml"})
  @Test
  ...
  public void testScriptInClasspathAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "classpath://org/cibseven/bpm/engine/test/bpmn/scripttask/greeting.py");
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("process", variables);
  ...
  public void testScriptNotFoundInClasspath() {
    try {
      ...
      testRule.assertTextPresentIgnoreCase("unable to find resource at path classpath://org/cibseven/bpm/engine/test/bpmn/scripttask/notexisting.py", e.getMessage());
    }
  }

  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/scripttask/ExternalScriptTaskTest.testScriptInDeployment.bpmn20.xml",
    "org/cibseven/bpm/engine/test/bpmn/scripttask/greeting.py"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/scripttask/ExternalScriptTaskTest.testScriptInDeploymentAsVariable.bpmn20.xml",
    "org/cibseven/bpm/engine/test/bpmn/scripttask/greeting.py"
  })
  @Test
  public void testScriptInDeploymentAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "deployment://org/cibseven/bpm/engine/test/bpmn/scripttask/greeting.py");
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("process", variables);
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/scripttask/ExternalScriptTaskTest.testScriptInDeploymentAsBean.bpmn20.xml",
    "org/cibseven/bpm/engine/test/bpmn/scripttask/greeting.py"
  })
  @Test
  ...
  public void testScriptNotFoundInDeployment() {
    try {
      ...
      testRule.assertTextPresentIgnoreCase("unable to find resource at path deployment://org/cibseven/bpm/engine/test/bpmn/scripttask/notexisting.py", e.getMessage());
    }
  }
