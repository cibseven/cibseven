...
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.decisionDefinitionByDeployTime;
...
public class DecisionDefinitionQueryTest {
  ...
  protected static final String DMN_ONE_RESOURCE = "org/cibseven/bpm/engine/test/repository/one.dmn";
  protected static final String DMN_TWO_RESOURCE = "org/cibseven/bpm/engine/test/repository/two.dmn";
  protected static final String DMN_THREE_RESOURCE = "org/cibseven/bpm/engine/test/api/repository/three_.dmn";
...
//  public RuleChain ruleChain = RuleChain.outerRule(engineRule).around(testRule);
  ...
  public void decisionDefinitionProperties() {
    ...
    assertThat(decisionDefinition.getResourceName()).isEqualTo("org/cibseven/bpm/engine/test/repository/one.dmn");
    ...
    assertThat(decisionDefinition.getVersion()).isEqualTo(1);
    assertThat(decisionDefinition.getResourceName()).isEqualTo("org/cibseven/bpm/engine/test/repository/two.dmn");
    assertThat(decisionDefinition.getDeploymentId()).isEqualTo(firstDeploymentId);
  }
  ...
  @org.cibseven.bpm.engine.test.Deployment(resources = {
    "org/cibseven/bpm/engine/test/api/repository/versionTag.dmn",
    "org/cibseven/bpm/engine/test/api/repository/versionTagHigher.dmn" })
  @Test
