...
import org.cibseven.bpm.engine.impl.cfg.BatchWindowConfiguration;
...
public class HistoryCleanupOnEngineBootstrapTest {
  ...
  public void testConsecutiveEngineBootstrapHistoryCleanupJobReconfiguration() {
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/batchwindow.camunda.cfg.xml")
      .buildProcessEngine()
      .close();
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/no-batchwindow.camunda.cfg.xml")
      .buildProcessEngine()
      .close();
  ...
  public void testDecreaseNumberOfHistoryCleanupJobs() {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/history-cleanup-parallelism-default.camunda.cfg.xml")
      .buildProcessEngine();
    ...
    .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/history-cleanup-parallelism-less.camunda.cfg.xml")
      .buildProcessEngine();
  ...
  public void testIncreaseNumberOfHistoryCleanupJobs() {
    ...
    // when
    engine = ProcessEngineConfiguration
    .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/history-cleanup-parallelism-more.camunda.cfg.xml")
      .buildProcessEngine();
  ...
  public void testBatchWindowXmlConfigParsingException() throws ParseException {
    ...
    assertThatThrownBy(() -> ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/history-cleanup-batch-window-map-wrong-values.camunda.cfg.xml")
      .buildProcessEngine())
  ...
  public void testBatchWindowMapInXmlConfig() throws ParseException {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/history-cleanup-batch-window-map.camunda.cfg.xml")
      .buildProcessEngine();
    ...
    engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/history/history-cleanup-batch-window-default.camunda.cfg.xml")
      .buildProcessEngine();
