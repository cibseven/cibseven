...
public class TenantIdProviderTest {
  ...
  protected static final String CONFIGURATION_RESOURCE = "org/cibseven/bpm/engine/test/api/multitenancy/TenantIdProviderTest.camunda.cfg.xml";
  ...
  protected static final BpmnModelInstance FAILING_PROCESS = Bpmn.createExecutableProcess(PROCESS_DEFINITION_KEY).startEvent()
      .serviceTask()
        .camundaClass("org.cibseven.bpm.engine.test.api.multitenancy.FailingDelegate")
        .camundaAsyncBefore()
      .done();

  protected static final String DMN_FILE = "org/cibseven/bpm/engine/test/api/multitenancy/simpleDecisionTable.dmn";

  protected static final String CMMN_FILE = "org/cibseven/bpm/engine/test/api/multitenancy/CaseWithCaseTask.cmmn";
  protected static final String CMMN_FILE_WITH_MANUAL_ACTIVATION = "org/cibseven/bpm/engine/test/api/multitenancy/CaseWithCaseTaskWithManualActivation.cmmn";
  protected static final String CMMN_VARIABLE_FILE = "org/cibseven/bpm/engine/test/api/multitenancy/CaseWithCaseTaskVariables.cmmn";
  protected static final String CMMN_SUBPROCESS_FILE = "org/cibseven/bpm/engine/test/api/cmmn/oneTaskCase.cmmn";
...
//  public RuleChain ruleChain = RuleChain.outerRule(engineRule).around(testRule);
  ...
  public void providerCalledForProcessDefinitionWithoutTenantId_ProcessTask() {
    ...
    testRule.deploy(
        ...
        "org/cibseven/bpm/engine/test/api/multitenancy/CaseWithProcessTask.cmmn");
