...
public class SentryCombinedEntryAndExitCriteriaTest extends CmmnTest {
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStage.cmmn"})
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentResumeInsideStageDifferentPlanItemOrder.cmmn"})
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStageDifferentPlanItemOrder.cmmn"})
