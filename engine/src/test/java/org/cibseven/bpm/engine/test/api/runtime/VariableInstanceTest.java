...
import org.cibseven.bpm.engine.test.bpmn.scripttask.MySerializable;
...
public class VariableInstanceTest extends PluggableProcessEngineTest {
    ...
    public void shouldNotDeleteByteArrayWhenTypeDoesNotChange() {
        ...
        deployProcess(Bpmn.createExecutableProcess("testProcess")
                ...
                .scriptTask()
                .scriptFormat("groovy")
                .scriptText("execution.setVariable('myVar', new org.cibseven.bpm.engine.test.bpmn.scripttask.MySerializable('updated value'))")
                .userTask()
                .endEvent()
                .done());
        ...
        assertThat(variable.getTextValue2())
                ...
                .isEqualTo("org.cibseven.bpm.engine.test.bpmn.scripttask.MySerializable");
    ...
    public void shouldDeleteByteArrayOnUpdateOfExistingNullVariable() {
        ...
        deployProcess(Bpmn.createExecutableProcess("testProcess")
                ...
                .scriptText("execution.setVariable('myVar', new org.cibseven.bpm.engine.test.bpmn.scripttask.MySerializable('non null value'))")
                .userTask()
                .endEvent()
                .done());
