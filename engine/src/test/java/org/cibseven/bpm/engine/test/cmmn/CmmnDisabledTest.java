...
public class CmmnDisabledTest {
  ...
  public void testTaskQueryAuthorization() {
    // given
    engineTestRule.deploy("org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml");
    engineTestRule.deploy("org/cibseven/bpm/engine/test/api/twoTasksProcess.bpmn20.xml");
