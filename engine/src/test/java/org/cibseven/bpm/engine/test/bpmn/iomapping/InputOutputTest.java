...
public class InputOutputTest extends PluggableProcessEngineTest {
  ...
  public void testInputExternalScriptValueAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy");
    runtimeService.startProcessInstanceByKey("testProcess", variables);
    Execution execution = runtimeService.createExecutionQuery().activityId("wait").singleResult();
  ...
  public void testInputExternalClasspathScriptValueAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "classpath://org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy");
    runtimeService.startProcessInstanceByKey("testProcess", variables);
    Execution execution = runtimeService.createExecutionQuery().activityId("wait").singleResult();
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputExternalDeploymentScriptValue.bpmn",
    "org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputExternalDeploymentScriptValueAsVariable.bpmn",
    "org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  public void testInputExternalDeploymentScriptValueAsVariable() {
    Map<String, Object> variables = new HashMap<String, Object>();
    variables.put("scriptPath", "deployment://org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy");
    runtimeService.startProcessInstanceByKey("testProcess", variables);
    Execution execution = runtimeService.createExecutionQuery().activityId("wait").singleResult();
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputExternalDeploymentScriptValueAsBean.bpmn",
    "org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInputMapElKey.bpmn")
  @Test
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputExternalDeploymentScriptValue.bpmn",
    "org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputExternalDeploymentScriptValueAsVariable.bpmn",
    "org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = {
    "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputExternalDeploymentScriptValueAsBean.bpmn",
    "org/cibseven/bpm/engine/test/bpmn/iomapping/oneplusone.groovy"
  })
  @Test
  ...
  @Deployment(resources = "org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testOutputMapElKey.bpmn")
  @Test
  ...
  public void testInterruptingEventSubprocessIoSupport() {
    try {
      repositoryService
        .createDeployment()
        .addClasspathResource("org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testInterruptingEventSubprocessIoSupport.bpmn")
        .deploy();
      fail("exception expected");
  ...
  public void testMIOutputMappingDisallowed() {
    try {
      ...
      .addClasspathResource("org/cibseven/bpm/engine/test/bpmn/iomapping/InputOutputTest.testMIOutputMappingDisallowed.bpmn20.xml")
      .deploy();
      fail("Exception expected");
    } catch (ParseException e) {
