...
public class MultiTenancyExecutionPropagationTest extends PluggableProcessEngineTest {
  ...
  protected static final String CMMN_FILE = "org/cibseven/bpm/engine/test/api/cmmn/oneTaskCase.cmmn";
  protected static final String SET_VARIABLE_CMMN_FILE = "org/cibseven/bpm/engine/test/api/multitenancy/HumanTaskSetVariableExecutionListener.cmmn";
  ...
  public void testPropagateTenantIdToCompensationEventSubscription() {
    ...
    testRule.deployForTenant(TENANT_ID, "org/cibseven/bpm/engine/test/api/multitenancy/compensationBoundaryEvent.bpmn");
