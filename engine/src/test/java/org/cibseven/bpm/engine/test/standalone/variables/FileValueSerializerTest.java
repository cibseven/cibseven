 ...
 */
package org.cibseven.bpm.engine.test.standalone.variables;
...
public class FileValueSerializerTest {
  ...
  public void testWriteMimetypeFilenameAndBytesValue() throws UnsupportedEncodingException {
    String filename = "test.txt";
    String mimeType = "text/json";
    InputStream is = this.getClass().getClassLoader().getResourceAsStream("org/cibseven/bpm/engine/test/standalone/variables/simpleFile.txt");
  ...
  public void testWriteMimetypeFilenameAndBytesValueWithShortcutMethod() throws URISyntaxException, UnsupportedEncodingException {
    File file = new File(this.getClass().getClassLoader().getResource("org/cibseven/bpm/engine/test/standalone/variables/simpleFile.txt").toURI());
