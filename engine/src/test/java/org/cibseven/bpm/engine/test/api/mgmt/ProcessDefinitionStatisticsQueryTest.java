...
public class ProcessDefinitionStatisticsQueryTest extends PluggableProcessEngineTest {
  ...
  public void testProcessDefinitionStatisticsQueryForMultipleVersions() {
    org.cibseven.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("org/cibseven/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQueryWithFailedJobs.bpmn20.xml")
          .deploy();
  ...
  public void testProcessDefinitionStatisticsQueryPagination() {
    org.cibseven.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("org/cibseven/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQuery.bpmn20.xml")
          .deploy();
  ...
  public void testProcessDefinitionStatisticsProperties() {
    String resourceName = "org/cibseven/bpm/engine/test/api/mgmt/ProcessDefinitionStatisticsQueryTest.testProcessDefinitionStatisticsProperties.bpmn20.xml";
