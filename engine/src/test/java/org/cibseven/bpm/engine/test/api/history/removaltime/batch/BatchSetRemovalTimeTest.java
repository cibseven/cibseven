...
import org.cibseven.bpm.engine.history.CleanableHistoricDecisionInstanceReportResult;
...
import org.cibseven.bpm.engine.test.api.runtime.BatchHelper;
...
public class BatchSetRemovalTimeTest {
  ...
  public void shouldCreateDeploymentAwareBatchJobs_ProcessInstances() {
    ...
    List<String> deploymentIds = engineRule.getRepositoryService().createDeploymentQuery()
        .list().stream()
        .map(org.cibseven.bpm.engine.repository.Deployment::getId)
  ...
  public void shouldCreateDeploymentAwareBatchJobs_StandaloneDecision() {
    ...
    engineTestRule.deploy("org/cibseven/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml");
    decisionService.evaluateDecisionByKey("dish-decision")
    .variables(
      Variables.createVariables()
        .putValue("temperature", 32)
  ...
  @Test
  @Deployment(resources = "org/cibseven/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml")
