...
import org.cibseven.bpm.engine.impl.cmmn.cmd.CompleteCaseExecutionCmd;
import org.cibseven.bpm.engine.impl.cmmn.cmd.ManualStartCaseExecutionCmd;
import org.cibseven.bpm.engine.impl.cmmn.cmd.StateTransitionCaseExecutionCmd;
...
public class CompetingSentrySatisfactionTest {
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testEntryCriteriaWithAndSentry.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testExitCriteriaWithAndSentry.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testEntryCriteriaWithOrSentry.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testExitCriteriaWithOrSentry.cmmn",
      "org/cibseven/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.oneTaskProcess.bpmn20.xml"})
  @Test
