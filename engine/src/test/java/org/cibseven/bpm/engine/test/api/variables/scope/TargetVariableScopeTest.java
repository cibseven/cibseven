 ...
 */
package org.cibseven.bpm.engine.test.api.variables.scope;
...
public class TargetVariableScopeTest {
  ...
  @Test
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/variables/scope/TargetVariableScopeTest.testExecutionWithScriptTargetScope.bpmn","org/cibseven/bpm/engine/test/api/variables/scope/doer.bpmn"})
  ...
  @Test
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/variables/scope/TargetVariableScopeTest.testExecutionWithoutProperTargetScope.bpmn","org/cibseven/bpm/engine/test/api/variables/scope/doer.bpmn"})
  public void testExecutionWithoutProperTargetScope () {
    ...
    assertThatThrownBy(() -> engineRule.getRuntimeService().startProcessInstanceByKey("Process_MultiInstanceCallAcitivity",variables))
      ...
      .hasMessageContaining("Unable to evaluate script while executing activity 'CallActivity_1' in the process definition with id '"
          + processDefinition.getId() + "': org.cibseven.bpm.engine.ProcessEngineException: ENGINE-20011 "
              + "Scope with specified activity Id NOT_EXISTING and execution");
  }

  @Test
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/variables/scope/doer.bpmn"})
          ...
          .embeddedSubProcess()
            .startEvent()
              .callActivity()
                ...
                .camundaVariableMappingClass("org.cibseven.bpm.engine.test.api.variables.scope.SetVariableMappingDelegate")
              .serviceTask()
                .camundaClass("org.cibseven.bpm.engine.test.api.variables.scope.AssertVariableScopeDelegate")
            .endEvent()
          .subProcessDone()
        .endEvent()
        .done();
  ...
  public void testWithDelegateVariableMappingAndChildScope () {
        ...
        .startEvent()
          .parallelGateway()
            ...
            .embeddedSubProcess()
              ...
              .callActivity()
                .calledElement("Process_StuffDoer")
                .camundaVariableMappingClass("org.cibseven.bpm.engine.test.api.variables.scope.SetVariableToChildMappingDelegate")
              .serviceTask()
                .camundaClass("org.cibseven.bpm.engine.test.api.variables.scope.AssertVariableScopeDelegate")
              .endEvent()
            .subProcessDone()
    ...
    assertThatThrownBy(() -> engineRule.getRuntimeService().startProcessInstanceById(processDefinition.getId(),variables))
      ...
      .hasMessageContaining("org.cibseven.bpm.engine.ProcessEngineException: ENGINE-20011 Scope with specified activity Id SubProcess_2 and execution");

  }

  public static class JavaDelegate implements org.cibseven.bpm.engine.delegate.JavaDelegate {
  ...
  public static class ExecutionListener implements org.cibseven.bpm.engine.delegate.ExecutionListener {
  ...
  public static class TaskListener implements org.cibseven.bpm.engine.delegate.TaskListener {
