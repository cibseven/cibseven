 ...
 */
package org.cibseven.bpm.engine.test.cmmn.processtask;
...
public class ProcessTaskTest extends CmmnTest {
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessAsExpressionStartsWithDollar.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessAsExpressionStartsWithHash.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallLatestProcess.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByDeployment.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersion.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersionAsExpressionStartsWithDollar.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersionAsExpressionStartsWithHash.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputBusinessKey.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputDifferentBusinessKey.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSource.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSourceDifferentTarget.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSourceExpression.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputAll.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputAllLocal.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputOverlapping.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/api/cmmn/oneProcessTaskCaseWithManualActivation.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSource.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSourceDifferentTarget.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSourceExpression.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputOverlapping.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAllWithManualActivation.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testVariablesRoundtrip.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputOutputAll.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testNonBlockingProcessTask.cmmn",
      "org/cibseven/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.cmmn",
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testNonBlockingProcessTaskAndProcessInstanceCompletesInOneGo.cmmn",
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testStartProcessInstanceAsync.cmmn",
      "org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testStartProcessInstanceAsync.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/api/cmmn/oneProcessTaskCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
      "org/cibseven/bpm/engine/test/cmmn/processtask/subProcessWithError.bpmn"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
  "org/cibseven/bpm/engine/test/cmmn/processtask/subProcessWithThrownError.bpmn"})
  @Test
