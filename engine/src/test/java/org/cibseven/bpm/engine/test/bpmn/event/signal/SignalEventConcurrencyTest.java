...
import org.cibseven.bpm.engine.test.concurrency.ConcurrencyTestHelper;
...
public class SignalEventConcurrencyTest extends ConcurrencyTestHelper {
  ...
  @Deployment(resources = {
      "org/cibseven/bpm/engine/test/bpmn/event/signal/SignalEventConcurrencyTest.testSignalWithCompletedExecution.bpmn20.xml" })
