...
import org.cibseven.bpm.engine.test.bpmn.async.FailingDelegate;
...
public class RemovalTimeStrategyStartTest extends AbstractRemovalTimeTest {
  ...
  @Test
  @Deployment( resources = {
    "org/cibseven/bpm/engine/test/api/history/removaltime/HistoricRootProcessInstanceTest.shouldResolveByteArray_DecisionOutputLiteralExpression.dmn"
  })
