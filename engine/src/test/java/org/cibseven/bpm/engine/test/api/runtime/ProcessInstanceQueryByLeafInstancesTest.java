...
//  @Rule
  ...
  @Deployment(resources = { "org/cibseven/bpm/engine/test/api/runtime/superProcessWithNestedSubProcess.bpmn20.xml",
      "org/cibseven/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml", "org/cibseven/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "org/cibseven/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
  ...
  @Test
  @Deployment(resources = { "org/cibseven/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
