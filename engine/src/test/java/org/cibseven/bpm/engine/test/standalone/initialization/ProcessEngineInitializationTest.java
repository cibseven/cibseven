...
public class ProcessEngineInitializationTest {
  ...
  public void testNoTables() {
    try {
      ...
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/standalone/initialization/notables.camunda.cfg.xml")
        .buildProcessEngine();
  ...
  public void testDefaultRetries() {
    ProcessEngineConfiguration configuration = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/standalone/initialization/defaultretries.camunda.cfg.xml");
  ...
  public void testCustomDefaultRetries() {
    ProcessEngineConfiguration configuration = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cibseven/bpm/engine/test/standalone/initialization/customdefaultretries.camunda.cfg.xml");
