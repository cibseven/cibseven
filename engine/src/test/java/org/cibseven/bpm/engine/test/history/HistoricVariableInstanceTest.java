...
import org.cibseven.bpm.engine.history.HistoricFormField;
...
import org.cibseven.bpm.engine.test.api.runtime.util.CustomSerializable;
import org.cibseven.bpm.engine.test.api.runtime.util.FailingSerializable;
import org.cibseven.bpm.engine.test.cmmn.decisiontask.TestPojo;
...
public class HistoricVariableInstanceTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
    "org/cibseven/bpm/engine/test/history/orderProcess.bpmn20.xml",
    "org/cibseven/bpm/engine/test/history/checkCreditProcess.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources={
      "org/cibseven/bpm/engine/test/history/HistoricVariableInstanceTest.testCallSubProcessSettingVariableOnStart.bpmn20.xml",
      "org/cibseven/bpm/engine/test/history/subProcessSetVariableOnStart.bpmn20.xml"
  })
  @Test
  ...
  @Deployment(resources={"org/cibseven/bpm/engine/test/standalone/history/FullHistoryTest.testVariableUpdatesAreLinkedToActivity.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"org/cibseven/bpm/engine/test/history/HistoricVariableInstanceTest.testParallel.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = "org/cibseven/bpm/engine/test/history/HistoricVariableInstanceTest.testNoImplicitUpdateOnHistoricValues.bpmn20.xml")
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/history/HistoricVariableInstanceTest.testHistoricVariableInstanceRevision.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/history/HistoricVariableInstanceTest.testHistoricVariableInstanceRevisionAsync.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources = "org/cibseven/bpm/engine/test/api/cmmn/twoTaskCase.cmmn")
  @Test
  ...
  public void testSetVariableInSubProcessStartEventWithEndListener () throws Exception {
    ...
    BpmnModelInstance subProcess = Bpmn.createExecutableProcess("subProcess")
        .startEvent()
        .camundaAsyncBefore()
        .camundaExecutionListenerClass(ExecutionListener.EVENTNAME_END, "org.cibseven.bpm.engine.test.history.SubProcessActivityStartListener")
        .endEvent()
        .done();
  ...
  @Deployment(resources = {"org/cibseven/bpm/engine/test/bpmn/async/AsyncStartEventTest.testMultipleAsyncStartEvents.bpmn20.xml"})
  @Test
