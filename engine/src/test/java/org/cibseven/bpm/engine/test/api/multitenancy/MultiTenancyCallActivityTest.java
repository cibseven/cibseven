...
public class MultiTenancyCallActivityTest extends PluggableProcessEngineTest {
  ...
  public void testStartProcessInstanceWithVersionTagBinding() {
    ...
    testRule.deployForTenant(TENANT_ONE, "org/cibseven/bpm/engine/test/bpmn/callactivity/subProcessWithVersionTag.bpmn20.xml");
    testRule.deployForTenant(TENANT_TWO, callingProcess);
    testRule.deployForTenant(TENANT_TWO, "org/cibseven/bpm/engine/test/bpmn/callactivity/subProcessWithVersionTag2.bpmn20.xml");
