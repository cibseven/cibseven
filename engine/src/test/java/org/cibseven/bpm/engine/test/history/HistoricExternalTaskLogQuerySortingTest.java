...
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskByTimestamp;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByActivityId;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByActivityInstanceId;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByExecutionId;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByExternalTaskId;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByPriority;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessDefinitionId;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessDefinitionKey;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessInstanceId;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByRetries;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByTopicName;
import static org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByWorkerId;
...
import static org.cibseven.bpm.engine.test.api.runtime.migration.models.builder.DefaultExternalTaskModelBuilder.createDefaultExternalTaskModel;
...
import org.cibseven.bpm.engine.test.api.runtime.TestOrderingUtil;
...
public class HistoricExternalTaskLogQuerySortingTest {
  ...
  protected ProcessEngineTestRule testHelper;
