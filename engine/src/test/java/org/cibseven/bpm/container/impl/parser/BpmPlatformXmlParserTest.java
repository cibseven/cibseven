 ...
 */
package org.cibseven.bpm.container.impl.parser;
...
import org.cibseven.bpm.container.impl.metadata.BpmPlatformXmlParser;
...
public class BpmPlatformXmlParserTest {
  ...
  public void testParseBpmPlatformXmlNoEngine() {
    ...
    assertEquals("org.cibseven.bpm.engine.impl.jobexecutor.DefaultJobExecutor", jobAcquisitionXml.getJobExecutorClassName());
  ...
  public void testParseBpmPlatformXmlEnginePlugin() {
    ...
    assertEquals("org.cibseven.bpm.MyAwesomePlugin", plugin1.getPluginClass());
