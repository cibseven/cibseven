...
import org.cibseven.connect.agentconnector.impl.AgentConnectorImpl;
import org.cibseven.connect.agentconnector.impl.AgentConnectorException;
...
public class AgentConnectorTest {
  ...
  public void shouldCreateRequestInstance() {
    ...
    assertThat(request).isInstanceOf(org.cibseven.connect.agentconnector.impl.AgentRequestImpl.class);
  }
