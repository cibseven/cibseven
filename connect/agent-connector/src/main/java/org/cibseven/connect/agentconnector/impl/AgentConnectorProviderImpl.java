...
/**
 * SPI provider that registers the {@link AgentConnectorImpl} with the
 ...
 */
public class AgentConnectorProviderImpl implements ConnectorProvider {

  @Override
  public String getConnectorId() {
    return AgentConnector.ID;
  }

  @Override
  public AgentConnector createConnectorInstance() {
    return new AgentConnectorImpl();
  }
