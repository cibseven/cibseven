...
/**
 * Response interface for the knowledge ingestor connector.
 */
public interface KnowledgeIngestorResponse extends ConnectorResponse {

  /** Returns the number of text chunks that were embedded and stored. */
  int getChunksIngested();
