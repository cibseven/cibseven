...
import org.cibseven.bpm.engine.test.assertions.AssertionsLogger;
...
public class ProcessInstanceAssert extends AbstractProcessAssert<ProcessInstanceAssert, ProcessInstance> {
   ...
   * @return  TaskAssert inspecting the only task available. Inspecting a
   *          'null' Task in case no such Task is available.
   * @throws  org.cibseven.bpm.engine.ProcessEngineException in case more than one
   ...
   *          available.
   * @throws  org.cibseven.bpm.engine.ProcessEngineException in case more than
