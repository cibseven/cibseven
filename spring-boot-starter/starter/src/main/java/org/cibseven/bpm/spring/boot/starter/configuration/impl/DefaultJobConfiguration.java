...
import static org.cibseven.bpm.spring.boot.starter.util.CamundaSpringBootUtil.join;
...
import org.cibseven.bpm.spring.boot.starter.event.JobExecutorStartingEventListener;
import org.cibseven.bpm.spring.boot.starter.property.CamundaBpmProperties;
import org.cibseven.bpm.spring.boot.starter.property.JobExecutionProperty;
...
public class DefaultJobConfiguration extends AbstractCamundaConfiguration implements CamundaJobConfiguration {
  ...
  protected void configureJobExecutor(SpringProcessEngineConfiguration configuration) {
    ...
    // org.cibseven.bpm.spring.boot.starter.runlistener.JobExecutorRunListener
